var Pc=Object.defineProperty;var Ac=(t,e,n)=>e in t?Pc(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var _o=(t,e,n)=>Ac(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const Cc=[{id:1,worldId:"arrays-strings",title:"The First Harvest",difficulty:"easy",concepts:["Array","Indexing"],story:{scenario:"Welcome to the Grid Kingdom. The crops are stored in a linear plot. The player must access the first crop from the array and harvest it.",objective:"Access the first element of the `crops` array and store it in a variable called `firstCrop`. Print it.",controls:["array[index]"]},relics:[{name:"WHEAT",x:20},{name:"CORN",x:50},{name:"CARROT",x:80}],hints:[{text:"In Java, array indices start at 0. So the first element is crops[0].",cost:0},{text:'Use crops[0] and print it: System.out.println("Harvested: " + firstCrop);',cost:10}],starterCode:`String[] crops = {"WHEAT", "CORN", "CARROT"};
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,Oe={alphahash_fragment:rd,alphahash_pars_fragment:od,alphamap_fragment:ld,alphamap_pars_fragment:cd,alphatest_fragment:fd,alphatest_pars_fragment:dd,aomap_fragment:ud,aomap_pars_fragment:hd,batching_pars_vertex:pd,batching_vertex:md,begin_vertex:Sd,beginnormal_vertex:gd,bsdfs:vd,iridescence_fragment:_d,bumpmap_pars_fragment:yd,clipping_planes_fragment:bd,clipping_planes_pars_fragment:Md,clipping_planes_pars_vertex:Td,clipping_planes_vertex:Hd,color_fragment:Ed,color_pars_fragment:Rd,color_pars_vertex:Pd,color_vertex:Ad,common:Cd,cube_uv_reflection_fragment:wd,defaultnormal_vertex:Bd,displacementmap_pars_vertex:Ld,displacementmap_vertex:Id,emissivemap_fragment:Dd,emissivemap_pars_fragment:xd,colorspace_fragment:Ud,colorspace_pars_fragment:Nd,envmap_fragment:Od,envmap_common_pars_fragment:Fd,envmap_pars_fragment:kd,envmap_pars_vertex:Gd,envmap_physical_pars_fragment:Zd,envmap_vertex:Wd,fog_vertex:zd,fog_pars_vertex:Xd,fog_fragment:Vd,fog_pars_fragment:Yd,gradientmap_pars_fragment:qd,lightmap_pars_fragment:Kd,lights_lambert_fragment:$d,lights_lambert_pars_fragment:Jd,lights_pars_begin:jd,lights_toon_fragment:Qd,lights_toon_pars_fragment:eu,lights_phong_fragment:tu,lights_phong_pars_fragment:nu,lights_physical_fragment:iu,lights_physical_pars_fragment:su,lights_fragment_begin:au,lights_fragment_maps:ru,lights_fragment_end:ou,lightprobes_pars_fragment:lu,logdepthbuf_fragment:cu,logdepthbuf_pars_fragment:fu,logdepthbuf_pars_vertex:du,logdepthbuf_vertex:uu,map_fragment:hu,map_pars_fragment:pu,map_particle_fragment:mu,map_particle_pars_fragment:Su,metalnessmap_fragment:gu,metalnessmap_pars_fragment:vu,morphinstance_vertex:_u,morphcolor_vertex:yu,morphnormal_vertex:bu,morphtarget_pars_vertex:Mu,morphtarget_vertex:Tu,normal_fragment_begin:Hu,normal_fragment_maps:Eu,normal_pars_fragment:Ru,normal_pars_vertex:Pu,normal_vertex:Au,normalmap_pars_fragment:Cu,clearcoat_normal_fragment_begin:wu,clearcoat_normal_fragment_maps:Bu,clearcoat_pars_fragment:Lu,iridescence_pars_fragment:Iu,opaque_fragment:Du,packing:xu,premultiplied_alpha_fragment:Uu,project_vertex:Nu,dithering_fragment:Ou,dithering_pars_fragment:Fu,roughnessmap_fragment:ku,roughnessmap_pars_fragment:Gu,shadowmap_pars_fragment:Wu,shadowmap_pars_vertex:zu,shadowmap_vertex:Xu,shadowmask_pars_fragment:Vu,skinbase_vertex:Yu,skinning_pars_vertex:qu,skinning_vertex:Ku,skinnormal_vertex:$u,specularmap_fragment:Ju,specularmap_pars_fragment:ju,tonemapping_fragment:Zu,tonemapping_pars_fragment:Qu,transmission_fragment:eh,transmission_pars_fragment:th,uv_pars_fragment:nh,uv_pars_vertex:ih,uv_vertex:sh,worldpos_vertex:ah,background_vert:rh,background_frag:oh,backgroundCube_vert:lh,backgroundCube_frag:ch,cube_vert:fh,cube_frag:dh,depth_vert:uh,depth_frag:hh,distance_vert:ph,distance_frag:mh,equirect_vert:Sh,equirect_frag:gh,linedashed_vert:vh,linedashed_frag:_h,meshbasic_vert:yh,meshbasic_frag:bh,meshlambert_vert:Mh,meshlambert_frag:Th,meshmatcap_vert:Hh,meshmatcap_frag:Eh,meshnormal_vert:Rh,meshnormal_frag:Ph,meshphong_vert:Ah,meshphong_frag:Ch,meshphysical_vert:wh,meshphysical_frag:Bh,meshtoon_vert:Lh,meshtoon_frag:Ih,points_vert:Dh,points_frag:xh,shadow_vert:Uh,shadow_frag:Nh,sprite_vert:Oh,sprite_frag:Fh},Se={common:{diffuse:{value:new je(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new xe},alphaMap:{value:null},alphaMapTransform:{value:new xe},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new xe}},envmap:{envMap:{value:null},envMapRotation:{value:new xe},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new xe}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new xe}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new xe},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new xe},normalScale:{value:new Ze(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new xe},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new xe}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new xe}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new xe}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new je(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null},probesSH:{value:null},probesMin:{value:new k},probesMax:{value:new k},probesResolution:{value:new k}},points:{diffuse:{value:new je(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new xe},alphaTest:{value:0},uvTransform:{value:new xe}},sprite:{diffuse:{value:new je(16777215)},opacity:{value:1},center:{value:new Ze(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new xe},alphaMap:{value:null},alphaMapTransform:{value:new xe},alphaTest:{value:0}}},cn={basic:{uniforms:xt([Se.common,Se.specularmap,Se.envmap,Se.aomap,Se.lightmap,Se.fog]),vertexShader:Oe.meshbasic_vert,fragmentShader:Oe.meshbasic_frag},lambert:{uniforms:xt([Se.common,Se.specularmap,Se.envmap,Se.aomap,Se.lightmap,Se.emissivemap,Se.bumpmap,Se.normalmap,Se.displacementmap,Se.fog,Se.lights,{emissive:{value:new je(0)},envMapIntensity:{value:1}}]),vertexShader:Oe.meshlambert_vert,fragmentShader:Oe.meshlambert_frag},phong:{uniforms:xt([Se.common,Se.specularmap,Se.envmap,Se.aomap,Se.lightmap,Se.emissivemap,Se.bumpmap,Se.normalmap,Se.displacementmap,Se.fog,Se.lights,{emissive:{value:new je(0)},specular:{value:new je(1118481)},shininess:{value:30},envMapIntensity:{value:1}}]),vertexShader:Oe.meshphong_vert,fragmentShader:Oe.meshphong_frag},standard:{uniforms:xt([Se.common,Se.envmap,Se.aomap,Se.lightmap,Se.emissivemap,Se.bumpmap,Se.normalmap,Se.displacementmap,Se.roughnessmap,Se.metalnessmap,Se.fog,Se.lights,{emissive:{value:new je(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Oe.meshphysical_vert,fragmentShader:Oe.meshphysical_frag},toon:{uniforms:xt([Se.common,Se.aomap,Se.lightmap,Se.emissivemap,Se.bumpmap,Se.normalmap,Se.displacementmap,Se.gradientmap,Se.fog,Se.lights,{emissive:{value:new je(0)}}]),vertexShader:Oe.meshtoon_vert,fragmentShader:Oe.meshtoon_frag},matcap:{uniforms:xt([Se.common,Se.bumpmap,Se.normalmap,Se.displacementmap,Se.fog,{matcap:{value:null}}]),vertexShader:Oe.meshmatcap_vert,fragmentShader:Oe.meshmatcap_frag},points:{uniforms:xt([Se.points,Se.fog]),vertexShader:Oe.points_vert,fragmentShader:Oe.points_frag},dashed:{uniforms:xt([Se.common,Se.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Oe.linedashed_vert,fragmentShader:Oe.linedashed_frag},depth:{uniforms:xt([Se.common,Se.displacementmap]),vertexShader:Oe.depth_vert,fragmentShader:Oe.depth_frag},normal:{uniforms:xt([Se.common,Se.bumpmap,Se.normalmap,Se.displacementmap,{opacity:{value:1}}]),vertexShader:Oe.meshnormal_vert,fragmentShader:Oe.meshnormal_frag},sprite:{uniforms:xt([Se.sprite,Se.fog]),vertexShader:Oe.sprite_vert,fragmentShader:Oe.sprite_frag},background:{uniforms:{uvTransform:{value:new xe},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Oe.background_vert,fragmentShader:Oe.background_frag},backgroundCube:{uniforms:{envMap:{value:null},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new xe}},vertexShader:Oe.backgroundCube_vert,fragmentShader:Oe.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Oe.cube_vert,fragmentShader:Oe.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Oe.equirect_vert,fragmentShader:Oe.equirect_frag},distance:{uniforms:xt([Se.common,Se.displacementmap,{referencePosition:{value:new k},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Oe.distance_vert,fragmentShader:Oe.distance_frag},shadow:{uniforms:xt([Se.lights,Se.fog,{color:{value:new je(0)},opacity:{value:1}}]),vertexShader:Oe.shadow_vert,fragmentShader:Oe.shadow_frag}};cn.physical={uniforms:xt([cn.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new xe},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new xe},clearcoatNormalScale:{value:new Ze(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new xe},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new xe},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new xe},sheen:{value:0},sheenColor:{value:new je(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new xe},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new xe},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new xe},transmissionSamplerSize:{value:new Ze},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new xe},attenuationDistance:{value:0},attenuationColor:{value:new je(0)},specularColor:{value:new je(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new xe},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new xe},anisotropyVector:{value:new Ze},anisotropyMap:{value:null},anisotropyMapTransform:{value:new xe}}]),vertexShader:Oe.meshphysical_vert,fragmentShader:Oe.meshphysical_frag};const Is={r:0,b:0,g:0},kh=new yt,ac=new xe;ac.set(-1,0,0,0,1,0,0,0,1);function Gh(t,e,n,i,s,a){const r=new je(0);let f=s===!0?0:1,c,o,l=null,u=0,d=null;function h(y){let E=y.isScene===!0?y.background:null;if(E&&E.isTexture){const T=y.backgroundBlurriness>0;E=e.get(E,T)}return E}function p(y){let E=!1;const T=h(y);T===null?m(r,f):T&&T.isColor&&(m(T,1),E=!0);const A=t.xr.getEnvironmentBlendMode();A==="additive"?n.buffers.color.setClear(0,0,0,1,a):A==="alpha-blend"&&n.buffers.color.setClear(0,0,0,0,a),(t.autoClear||E)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil))}function g(y,E){const T=h(E);T&&(T.isCubeTexture||T.mapping===ta)?(o===void 0&&(o=new pt(new Ht(1,1,1),new gn({name:"BackgroundCubeMaterial",uniforms:Di(cn.backgroundCube.uniforms),vertexShader:cn.backgroundCube.vertexShader,fragmentShader:cn.backgroundCube.fragmentShader,side:Gt,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),o.geometry.deleteAttribute("normal"),o.geometry.deleteAttribute("uv"),o.onBeforeRender=function(A,R,w){this.matrixWorld.copyPosition(w.matrixWorld)},Object.defineProperty(o.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),i.update(o)),o.material.uniforms.envMap.value=T,o.material.uniforms.backgroundBlurriness.value=E.backgroundBlurriness,o.material.uniforms.backgroundIntensity.value=E.backgroundIntensity,o.material.uniforms.backgroundRotation.value.setFromMatrix4(kh.makeRotationFromEuler(E.backgroundRotation)).transpose(),T.isCubeTexture&&T.isRenderTargetTexture===!1&&o.material.uniforms.backgroundRotation.value.premultiply(ac),o.material.toneMapped=Ve.getTransfer(T.colorSpace)!==et,(l!==T||u!==T.version||d!==t.toneMapping)&&(o.material.needsUpdate=!0,l=T,u=T.version,d=t.toneMapping),o.layers.enableAll(),y.unshift(o,o.geometry,o.material,0,0,null)):T&&T.isTexture&&(c===void 0&&(c=new pt(new na(2,2),new gn({name:"BackgroundMaterial",uniforms:Di(cn.background.uniforms),vertexShader:cn.background.vertexShader,fragmentShader:cn.background.fragmentShader,side:Yn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute("normal"),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),i.update(c)),c.material.uniforms.t2D.value=T,c.material.uniforms.backgroundIntensity.value=E.backgroundIntensity,c.material.toneMapped=Ve.getTransfer(T.colorSpace)!==et,T.matrixAutoUpdate===!0&&T.updateMatrix(),c.material.uniforms.uvTransform.value.copy(T.matrix),(l!==T||u!==T.version||d!==t.toneMapping)&&(c.material.needsUpdate=!0,l=T,u=T.version,d=t.toneMapping),c.layers.enableAll(),y.unshift(c,c.geometry,c.material,0,0,null))}function m(y,E){y.getRGB(Is,tc(t)),n.buffers.color.setClear(Is.r,Is.g,Is.b,E,a)}function S(){o!==void 0&&(o.geometry.dispose(),o.material.dispose(),o=void 0),c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0)}return{getClearColor:function(){return r},setClearColor:function(y,E=1){r.set(y),f=E,m(r,f)},getClearAlpha:function(){return f},setClearAlpha:function(y){f=y,m(r,f)},render:p,addToRenderList:g,dispose:S}}function Wh(t,e){const n=t.getParameter(t.MAX_VERTEX_ATTRIBS),i={},s=d(null);let a=s,r=!1;function f(P,x,X,q,B){let F=!1;const O=u(P,q,X,x);a!==O&&(a=O,o(a.object)),F=h(P,q,X,B),F&&p(P,q,X,B),B!==null&&e.update(B,t.ELEMENT_ARRAY_BUFFER),(F||r)&&(r=!1,T(P,x,X,q),B!==null&&t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,e.get(B).buffer))}function c(){return t.createVertexArray()}function o(P){return t.bindVertexArray(P)}function l(P){return t.deleteVertexArray(P)}function u(P,x,X,q){const B=q.wireframe===!0;let F=i[x.id];F===void 0&&(F={},i[x.id]=F);const O=P.isInstancedMesh===!0?P.id:0;let ne=F[O];ne===void 0&&(ne={},F[O]=ne);let ie=ne[X.id];ie===void 0&&(ie={},ne[X.id]=ie);let ue=ie[B];return ue===void 0&&(ue=d(c()),ie[B]=ue),ue}function d(P){const x=[],X=[],q=[];for(let B=0;B<n;B++)x[B]=0,X[B]=0,q[B]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:x,enabledAttributes:X,attributeDivisors:q,object:P,attributes:{},index:null}}function h(P,x,X,q){const B=a.attributes,F=x.attributes;let O=0;const ne=X.getAttributes();for(const ie in ne)if(ne[ie].location>=0){const Me=B[ie];let Te=F[ie];if(Te===void 0&&(ie==="instanceMatrix"&&P.instanceMatrix&&(Te=P.instanceMatrix),ie==="instanceColor"&&P.instanceColor&&(Te=P.instanceColor)),Me===void 0||Me.attribute!==Te||Te&&Me.data!==Te.data)return!0;O++}return a.attributesNum!==O||a.index!==q}function p(P,x,X,q){const B={},F=x.attributes;let O=0;const ne=X.getAttributes();for(const ie in ne)if(ne[ie].location>=0){let Me=F[ie];Me===void 0&&(ie==="instanceMatrix"&&P.instanceMatrix&&(Me=P.instanceMatrix),ie==="instanceColor"&&P.instanceColor&&(Me=P.instanceColor));const Te={};Te.attribute=Me,Me&&Me.data&&(Te.data=Me.data),B[ie]=Te,O++}a.attributes=B,a.attributesNum=O,a.index=q}function g(){const P=a.newAttributes;for(let x=0,X=P.length;x<X;x++)P[x]=0}function m(P){S(P,0)}function S(P,x){const X=a.newAttributes,q=a.enabledAttributes,B=a.attributeDivisors;X[P]=1,q[P]===0&&(t.enableVertexAttribArray(P),q[P]=1),B[P]!==x&&(t.vertexAttribDivisor(P,x),B[P]=x)}function y(){const P=a.newAttributes,x=a.enabledAttributes;for(let X=0,q=x.length;X<q;X++)x[X]!==P[X]&&(t.disableVertexAttribArray(X),x[X]=0)}function E(P,x,X,q,B,F,O){O===!0?t.vertexAttribIPointer(P,x,X,B,F):t.vertexAttribPointer(P,x,X,q,B,F)}function T(P,x,X,q){g();const B=q.attributes,F=X.getAttributes(),O=x.defaultAttributeValues;for(const ne in F){const ie=F[ne];if(ie.location>=0){let ue=B[ne];if(ue===void 0&&(ne==="instanceMatrix"&&P.instanceMatrix&&(ue=P.instanceMatrix),ne==="instanceColor"&&P.instanceColor&&(ue=P.instanceColor)),ue!==void 0){const Me=ue.normalized,Te=ue.itemSize,ke=e.get(ue);if(ke===void 0)continue;const qe=ke.buffer,Ie=ke.type,K=ke.bytesPerElement,he=Ie===t.INT||Ie===t.UNSIGNED_INT||ue.gpuType===zr;if(ue.isInterleavedBufferAttribute){const de=ue.data,Ae=de.stride,Le=ue.offset;if(de.isInstancedInterleavedBuffer){for(let Ce=0;Ce<ie.locationSize;Ce++)S(ie.location+Ce,de.meshPerAttribute);P.isInstancedMesh!==!0&&q._maxInstanceCount===void 0&&(q._maxInstanceCount=de.meshPerAttribute*de.count)}else for(let Ce=0;Ce<ie.locationSize;Ce++)m(ie.location+Ce);t.bindBuffer(t.ARRAY_BUFFER,qe);for(let Ce=0;Ce<ie.locationSize;Ce++)E(ie.location+Ce,Te/ie.locationSize,Ie,Me,Ae*K,(Le+Te/ie.locationSize*Ce)*K,he)}else{if(ue.isInstancedBufferAttribute){for(let de=0;de<ie.locationSize;de++)S(ie.location+de,ue.meshPerAttribute);P.isInstancedMesh!==!0&&q._maxInstanceCount===void 0&&(q._maxInstanceCount=ue.meshPerAttribute*ue.count)}else for(let de=0;de<ie.locationSize;de++)m(ie.location+de);t.bindBuffer(t.ARRAY_BUFFER,qe);for(let de=0;de<ie.locationSize;de++)E(ie.location+de,Te/ie.locationSize,Ie,Me,Te*K,Te/ie.locationSize*de*K,he)}}else if(O!==void 0){const Me=O[ne];if(Me!==void 0)switch(Me.length){case 2:t.vertexAttrib2fv(ie.location,Me);break;case 3:t.vertexAttrib3fv(ie.location,Me);break;case 4:t.vertexAttrib4fv(ie.location,Me);break;default:t.vertexAttrib1fv(ie.location,Me)}}}}y()}function A(){M();for(const P in i){const x=i[P];for(const X in x){const q=x[X];for(const B in q){const F=q[B];for(const O in F)l(F[O].object),delete F[O];delete q[B]}}delete i[P]}}function R(P){if(i[P.id]===void 0)return;const x=i[P.id];for(const X in x){const q=x[X];for(const B in q){const F=q[B];for(const O in F)l(F[O].object),delete F[O];delete q[B]}}delete i[P.id]}function w(P){for(const x in i){const X=i[x];for(const q in X){const B=X[q];if(B[P.id]===void 0)continue;const F=B[P.id];for(const O in F)l(F[O].object),delete F[O];delete B[P.id]}}}function _(P){for(const x in i){const X=i[x],q=P.isInstancedMesh===!0?P.id:0,B=X[q];if(B!==void 0){for(const F in B){const O=B[F];for(const ne in O)l(O[ne].object),delete O[ne];delete B[F]}delete X[q],Object.keys(X).length===0&&delete i[x]}}}function M(){L(),r=!0,a!==s&&(a=s,o(a.object))}function L(){s.geometry=null,s.program=null,s.wireframe=!1}return{setup:f,reset:M,resetDefaultState:L,dispose:A,releaseStatesOfGeometry:R,releaseStatesOfObject:_,releaseStatesOfProgram:w,initAttributes:g,enableAttribute:m,disableUnusedAttributes:y}}function zh(t,e,n){let i;function s(c){i=c}function a(c,o){t.drawArrays(i,c,o),n.update(o,i,1)}function r(c,o,l){l!==0&&(t.drawArraysInstanced(i,c,o,l),n.update(o,i,l))}function f(c,o,l){if(l===0)return;e.get("WEBGL_multi_draw").multiDrawArraysWEBGL(i,c,0,o,0,l);let d=0;for(let h=0;h<l;h++)d+=o[h];n.update(d,i,1)}this.setMode=s,this.render=a,this.renderInstances=r,this.renderMultiDraw=f}function Xh(t,e,n,i){let s;function a(){if(s!==void 0)return s;if(e.has("EXT_texture_filter_anisotropic")===!0){const w=e.get("EXT_texture_filter_anisotropic");s=t.getParameter(w.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else s=0;return s}function r(w){return!(w!==nn&&i.convert(w)!==t.getParameter(t.IMPLEMENTATION_COLOR_READ_FORMAT))}function f(w){const _=w===wn&&(e.has("EXT_color_buffer_half_float")||e.has("EXT_color_buffer_float"));return!(w!==Vt&&i.convert(w)!==t.getParameter(t.IMPLEMENTATION_COLOR_READ_TYPE)&&w!==dn&&!_)}function c(w){if(w==="highp"){if(t.getShaderPrecisionFormat(t.VERTEX_SHADER,t.HIGH_FLOAT).precision>0&&t.getShaderPrecisionFormat(t.FRAGMENT_SHADER,t.HIGH_FLOAT).precision>0)return"highp";w="mediump"}return w==="mediump"&&t.getShaderPrecisionFormat(t.VERTEX_SHADER,t.MEDIUM_FLOAT).precision>0&&t.getShaderPrecisionFormat(t.FRAGMENT_SHADER,t.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let o=n.precision!==void 0?n.precision:"highp";const l=c(o);l!==o&&(Be("WebGLRenderer:",o,"not supported, using",l,"instead."),o=l);const u=n.logarithmicDepthBuffer===!0,d=n.reversedDepthBuffer===!0&&e.has("EXT_clip_control");n.reversedDepthBuffer===!0&&d===!1&&Be("WebGLRenderer: Unable to use reversed depth buffer due to missing EXT_clip_control extension. Fallback to default depth buffer.");const h=t.getParameter(t.MAX_TEXTURE_IMAGE_UNITS),p=t.getParameter(t.MAX_VERTEX_TEXTURE_IMAGE_UNITS),g=t.getParameter(t.MAX_TEXTURE_SIZE),m=t.getParameter(t.MAX_CUBE_MAP_TEXTURE_SIZE),S=t.getParameter(t.MAX_VERTEX_ATTRIBS),y=t.getParameter(t.MAX_VERTEX_UNIFORM_VECTORS),E=t.getParameter(t.MAX_VARYING_VECTORS),T=t.getParameter(t.MAX_FRAGMENT_UNIFORM_VECTORS),A=t.getParameter(t.MAX_SAMPLES),R=t.getParameter(t.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:a,getMaxPrecision:c,textureFormatReadable:r,textureTypeReadable:f,precision:o,logarithmicDepthBuffer:u,reversedDepthBuffer:d,maxTextures:h,maxVertexTextures:p,maxTextureSize:g,maxCubemapSize:m,maxAttributes:S,maxVertexUniforms:y,maxVaryings:E,maxFragmentUniforms:T,maxSamples:A,samples:R}}function Vh(t){const e=this;let n=null,i=0,s=!1,a=!1;const r=new ei,f=new xe,c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(u,d){const h=u.length!==0||d||i!==0||s;return s=d,i=u.length,h},this.beginShadows=function(){a=!0,l(null)},this.endShadows=function(){a=!1},this.setGlobalState=function(u,d){n=l(u,d,0)},this.setState=function(u,d,h){const p=u.clippingPlanes,g=u.clipIntersection,m=u.clipShadows,S=t.get(u);if(!s||p===null||p.length===0||a&&!m)a?l(null):o();else{const y=a?0:i,E=y*4;let T=S.clippingState||null;c.value=T,T=l(p,d,E,h);for(let A=0;A!==E;++A)T[A]=n[A];S.clippingState=T,this.numIntersection=g?this.numPlanes:0,this.numPlanes+=y}};function o(){c.value!==n&&(c.value=n,c.needsUpdate=i>0),e.numPlanes=i,e.numIntersection=0}function l(u,d,h,p){const g=u!==null?u.length:0;let m=null;if(g!==0){if(m=c.value,p!==!0||m===null){const S=h+g*4,y=d.matrixWorldInverse;f.getNormalMatrix(y),(m===null||m.length<S)&&(m=new Float32Array(S));for(let E=0,T=h;E!==g;++E,T+=4)r.copy(u[E]).applyMatrix4(y,f),r.normal.toArray(m,T),m[T+3]=r.constant}c.value=m,c.needsUpdate=!0}return e.numPlanes=g,e.numIntersection=0,m}}const Xn=4,jo=[.125,.215,.35,.446,.526,.582],ii=20,Yh=256,Vi=new to,Zo=new je;let xa=null,Ua=0,Na=0,Oa=!1;const qh=new k;class Qo{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._sigmas=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(e,n=0,i=.1,s=100,a={}){const{size:r=256,position:f=qh}=a;xa=this._renderer.getRenderTarget(),Ua=this._renderer.getActiveCubeFace(),Na=this._renderer.getActiveMipmapLevel(),Oa=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(r);const c=this._allocateTargets();return c.depthBuffer=!0,this._sceneToCubeUV(e,i,s,c,f),n>0&&this._blur(c,0,0,n),this._applyPMREM(c),this._cleanup(c),c}fromEquirectangular(e,n=null){return this._fromTexture(e,n)}fromCubemap(e,n=null){return this._fromTexture(e,n)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=nl(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=tl(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodMeshes.length;e++)this._lodMeshes[e].geometry.dispose()}_cleanup(e){this._renderer.setRenderTarget(xa,Ua,Na),this._renderer.xr.enabled=Oa,e.scissorTest=!1,Ri(e,0,0,e.width,e.height)}_fromTexture(e,n){e.mapping===oi||e.mapping===Li?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),xa=this._renderer.getRenderTarget(),Ua=this._renderer.getActiveCubeFace(),Na=this._renderer.getActiveMipmapLevel(),Oa=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const i=n||this._allocateTargets();return this._textureToCubeUV(e,i),this._applyPMREM(i),this._cleanup(i),i}_allocateTargets(){const e=3*Math.max(this._cubeSize,112),n=4*this._cubeSize,i={magFilter:It,minFilter:It,generateMipmaps:!1,type:wn,format:nn,colorSpace:$s,depthBuffer:!1},s=el(e,n,i);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==n){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=el(e,n,i);const{_lodMax:a}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods,sigmas:this._sigmas}=Kh(a)),this._blurMaterial=Jh(a,e,n),this._ggxMaterial=$h(a,e,n)}return s}_compileMaterial(e){const n=new pt(new sn,e);this._renderer.compile(n,Vi)}_sceneToCubeUV(e,n,i,s,a){const c=new Jt(90,1,n,i),o=[1,-1,1,1,1,1],l=[1,1,1,-1,-1,-1],u=this._renderer,d=u.autoClear,h=u.toneMapping;u.getClearColor(Zo),u.toneMapping=hn,u.autoClear=!1,u.state.buffers.depth.getReversed()&&(u.setRenderTarget(s),u.clearDepth(),u.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new pt(new Ht,new Zl({name:"PMREM.Background",side:Gt,depthWrite:!1,depthTest:!1})));const g=this._backgroundBox,m=g.material;let S=!1;const y=e.background;y?y.isColor&&(m.color.copy(y),e.background=null,S=!0):(m.color.copy(Zo),S=!0);for(let E=0;E<6;E++){const T=E%3;T===0?(c.up.set(0,o[E],0),c.position.set(a.x,a.y,a.z),c.lookAt(a.x+l[E],a.y,a.z)):T===1?(c.up.set(0,0,o[E]),c.position.set(a.x,a.y,a.z),c.lookAt(a.x,a.y+l[E],a.z)):(c.up.set(0,o[E],0),c.position.set(a.x,a.y,a.z),c.lookAt(a.x,a.y,a.z+l[E]));const A=this._cubeSize;Ri(s,T*A,E>2?A:0,A,A),u.setRenderTarget(s),S&&u.render(g,c),u.render(e,c)}u.toneMapping=h,u.autoClear=d,e.background=y}_textureToCubeUV(e,n){const i=this._renderer,s=e.mapping===oi||e.mapping===Li;s?(this._cubemapMaterial===null&&(this._cubemapMaterial=nl()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=tl());const a=s?this._cubemapMaterial:this._equirectMaterial,r=this._lodMeshes[0];r.material=a;const f=a.uniforms;f.envMap.value=e;const c=this._cubeSize;Ri(n,0,0,3*c,2*c),i.setRenderTarget(n),i.render(r,Vi)}_applyPMREM(e){const n=this._renderer,i=n.autoClear;n.autoClear=!1;const s=this._lodMeshes.length;for(let a=1;a<s;a++)this._applyGGXFilter(e,a-1,a);n.autoClear=i}_applyGGXFilter(e,n,i){const s=this._renderer,a=this._pingPongRenderTarget,r=this._ggxMaterial,f=this._lodMeshes[i];f.material=r;const c=r.uniforms,o=i/(this._lodMeshes.length-1),l=n/(this._lodMeshes.length-1),u=Math.sqrt(o*o-l*l),d=0+o*1.25,h=u*d,{_lodMax:p}=this,g=this._sizeLods[i],m=3*g*(i>p-Xn?i-p+Xn:0),S=4*(this._cubeSize-g);c.envMap.value=e.texture,c.roughness.value=h,c.mipInt.value=p-n,Ri(a,m,S,3*g,2*g),s.setRenderTarget(a),s.render(f,Vi),c.envMap.value=a.texture,c.roughness.value=0,c.mipInt.value=p-i,Ri(e,m,S,3*g,2*g),s.setRenderTarget(e),s.render(f,Vi)}_blur(e,n,i,s,a){const r=this._pingPongRenderTarget;this._halfBlur(e,r,n,i,s,"latitudinal",a),this._halfBlur(r,e,i,i,s,"longitudinal",a)}_halfBlur(e,n,i,s,a,r,f){const c=this._renderer,o=this._blurMaterial;r!=="latitudinal"&&r!=="longitudinal"&&Je("blur direction must be either latitudinal or longitudinal!");const l=3,u=this._lodMeshes[s];u.material=o;const d=o.uniforms,h=this._sizeLods[i]-1,p=isFinite(a)?Math.PI/(2*h):2*Math.PI/(2*ii-1),g=a/p,m=isFinite(a)?1+Math.floor(l*g):ii;m>ii&&Be(`sigmaRadians, ${a}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${ii}`);const S=[];let y=0;for(let w=0;w<ii;++w){const _=w/g,M=Math.exp(-_*_/2);S.push(M),w===0?y+=M:w<m&&(y+=2*M)}for(let w=0;w<S.length;w++)S[w]=S[w]/y;d.envMap.value=e.texture,d.samples.value=m,d.weights.value=S,d.latitudinal.value=r==="latitudinal",f&&(d.poleAxis.value=f);const{_lodMax:E}=this;d.dTheta.value=p,d.mipInt.value=E-i;const T=this._sizeLods[s],A=3*T*(s>E-Xn?s-E+Xn:0),R=4*(this._cubeSize-T);Ri(n,A,R,3*T,2*T),c.setRenderTarget(n),c.render(u,Vi)}}function Kh(t){const e=[],n=[],i=[];let s=t;const a=t-Xn+1+jo.length;for(let r=0;r<a;r++){const f=Math.pow(2,s);e.push(f);let c=1/f;r>t-Xn?c=jo[r-t+Xn-1]:r===0&&(c=0),n.push(c);const o=1/(f-2),l=-o,u=1+o,d=[l,l,u,l,u,u,l,l,u,u,l,u],h=6,p=6,g=3,m=2,S=1,y=new Float32Array(g*p*h),E=new Float32Array(m*p*h),T=new Float32Array(S*p*h);for(let R=0;R<h;R++){const w=R%3*2/3-1,_=R>2?0:-1,M=[w,_,0,w+2/3,_,0,w+2/3,_+1,0,w,_,0,w+2/3,_+1,0,w,_+1,0];y.set(M,g*p*R),E.set(d,m*p*R);const L=[R,R,R,R,R,R];T.set(L,S*p*R)}const A=new sn;A.setAttribute("position",new mn(y,g)),A.setAttribute("uv",new mn(E,m)),A.setAttribute("faceIndex",new mn(T,S)),i.push(new pt(A,null)),s>Xn&&s--}return{lodMeshes:i,sizeLods:e,sigmas:n}}function el(t,e,n){const i=new pn(t,e,n);return i.texture.mapping=ta,i.texture.name="PMREM.cubeUv",i.scissorTest=!0,i}function Ri(t,e,n,i,s){t.viewport.set(e,n,i,s),t.scissor.set(e,n,i,s)}function $h(t,e,n){return new gn({name:"PMREMGGXConvolution",defines:{GGX_SAMPLES:Yh,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:ia(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Jh(t,e,n){const i=new Float32Array(ii),s=new k(0,1,0);return new gn({name:"SphericalGaussianBlur",defines:{n:ii,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ia(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function tl(){return new gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ia(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function nl(){return new gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ia(),fragmentShader:`
	...
	`}class rc extends pn{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new Ql(s),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Ht(5,5,5),a=new gn({name:"CubemapFromEquirect",uniforms:Di(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Gt,blending:An});a.uniforms.tEquirect.value=n;const r=new pt(s,a),f=n.minFilter;return n.minFilter===si&&(n.minFilter=It),new nd(1,10,this).update(e,r),n.minFilter=f,r.geometry.dispose(),r.material.dispose(),this}clear(e,n=!0,i=!0,s=!0){const a=e.getRenderTarget();for(let r=0;r<6;r++)e.setRenderTarget(this,r),e.clear(n,i,s);e.setRenderTarget(a)}}function jh(t){let e=new WeakMap,n=new WeakMap,i=null;function s(d,h=!1){return d==null?null:h?r(d):a(d)}function a(d){if(d&&d.isTexture){const h=d.mapping;if(h===oa||h===la)if(e.has(d)){const p=e.get(d).texture;return f(p,d.mapping)}else{const p=d.image;if(p&&p.height>0){const g=new rc(p.height);return g.fromEquirectangularTexture(t,d),e.set(d,g),d.addEventListener("dispose",o),f(g.texture,d.mapping)}else return null}}return d}function r(d){if(d&&d.isTexture){const h=d.mapping,p=h===oa||h===la,g=h===oi||h===Li;if(p||g){let m=n.get(d);const S=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==S)return i===null&&(i=new Qo(t)),m=p?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),m.texture;if(m!==void 0)return m.texture;{const y=d.image;return p&&y&&y.height>0||g&&y&&c(y)?(i===null&&(i=new Qo(t)),m=p?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),d.addEventListener("dispose",l),m.texture):null}}}return d}function f(d,h){return h===oa?d.mapping=oi:h===la&&(d.mapping=Li),d}function c(d){let h=0;const p=6;for(let g=0;g<p;g++)d[g]!==void 0&&h++;return h===p}function o(d){const h=d.target;h.removeEventListener("dispose",o);const p=e.get(h);p!==void 0&&(e.delete(h),p.dispose())}function l(d){const h=d.target;h.removeEventListener("dispose",l);const p=n.get(h);p!==void 0&&(n.delete(h),p.dispose())}function u(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:u}}function Zh(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const s=t.getExtension(i);return e[i]=s,s}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const s=n(i);return s===null&&Dr("WebGLRenderer: "+i+" extension not supported."),s}}}function Qh(t,e,n,i){const s={},a=new WeakMap;function r(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const p in d.attributes)e.remove(d.attributes[p]);d.removeEventListener("dispose",r),delete s[d.id];const h=a.get(d);h&&(e.remove(h),a.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,n.memory.geometries--}function f(u,d){return s[d.id]===!0||(d.addEventListener("dispose",r),s[d.id]=!0,n.memory.geometries++),d}function c(u){const d=u.attributes;for(const h in d)e.update(d[h],t.ARRAY_BUFFER)}function o(u){const d=[],h=u.index,p=u.attributes.position;let g=0;if(p===void 0)return;if(h!==null){const y=h.array;g=h.version;for(let E=0,T=y.length;E<T;E+=3){const A=y[E+0],R=y[E+1],w=y[E+2];d.push(A,R,R,w,w,A)}}else{const y=p.array;g=p.version;for(let E=0,T=y.length/3-1;E<T;E+=3){const A=E+0,R=E+1,w=E+2;d.push(A,R,R,w,w,A)}}const m=new(p.count>=65535?jl:Jl)(d,1);m.version=g;const S=a.get(u);S&&e.remove(S),a.set(u,m)}function l(u){const d=a.get(u);if(d){const h=u.index;h!==null&&d.version<h.version&&o(u)}else o(u);return a.get(u)}return{get:f,update:c,getWireframeAttribute:l}}function ep(t,e,n){let i;function s(u){i=u}let a,r;function f(u){a=u.type,r=u.bytesPerElement}function c(u,d){t.drawElements(i,d,a,u*r),n.update(d,i,1)}function o(u,d,h){h!==0&&(t.drawElementsInstanced(i,d,a,u*r,h),n.update(d,i,h))}function l(u,d,h){if(h===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,a,u,0,h);let g=0;for(let m=0;m<h;m++)g+=d[m];n.update(g,i,1)}this.setMode=s,this.setIndex=f,this.render=c,this.renderInstances=o,this.renderMultiDraw=l}function tp(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(a,r,f){switch(n.calls++,r){case t.TRIANGLES:n.triangles+=f*(a/3);break;case t.LINES:n.lines+=f*(a/2);break;case t.LINE_STRIP:n.lines+=f*(a-1);break;case t.LINE_LOOP:n.lines+=f*a;break;case t.POINTS:n.points+=f*a;break;default:Je("WebGLInfo: Unknown draw mode:",r);break}}function s(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:s,update:i}}function np(t,e,n){const i=new WeakMap,s=new mt;function a(r,f,c){const o=r.morphTargetInfluences,l=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,u=l!==void 0?l.length:0;let d=i.get(f);if(d===void 0||d.count!==u){let L=function(){_.dispose(),i.delete(f),f.removeEventListener("dispose",L)};var h=L;d!==void 0&&d.texture.dispose();const p=f.morphAttributes.position!==void 0,g=f.morphAttributes.normal!==void 0,m=f.morphAttributes.color!==void 0,S=f.morphAttributes.position||[],y=f.morphAttributes.normal||[],E=f.morphAttributes.color||[];let T=0;p===!0&&(T=1),g===!0&&(T=2),m===!0&&(T=3);let A=f.attributes.position.count*T,R=1;A>e.maxTextureSize&&(R=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const w=new Float32Array(A*R*4*u),_=new ql(w,A,R,u);_.type=dn,_.needsUpdate=!0;const M=T*4;for(let P=0;P<u;P++){const x=S[P],X=y[P],q=E[P],B=A*R*4*P;for(let F=0;F<x.count;F++){const O=F*M;p===!0&&(s.fromBufferAttribute(x,F),w[B+O+0]=s.x,w[B+O+1]=s.y,w[B+O+2]=s.z,w[B+O+3]=0),g===!0&&(s.fromBufferAttribute(X,F),w[B+O+4]=s.x,w[B+O+5]=s.y,w[B+O+6]=s.z,w[B+O+7]=0),m===!0&&(s.fromBufferAttribute(q,F),w[B+O+8]=s.x,w[B+O+9]=s.y,w[B+O+10]=s.z,w[B+O+11]=q.itemSize===4?s.w:1)}}d={count:u,texture:_,size:new Ze(A,R)},i.set(f,d),f.addEventListener("dispose",L)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)c.getUniforms().setValue(t,"morphTexture",r.morphTexture,n);else{let p=0;for(let m=0;m<o.length;m++)p+=o[m];const g=f.morphTargetsRelative?1:1-p;c.getUniforms().setValue(t,"morphTargetBaseInfluence",g),c.getUniforms().setValue(t,"morphTargetInfluences",o)}c.getUniforms().setValue(t,"morphTargetsTexture",d.texture,n),c.getUniforms().setValue(t,"morphTargetsTextureSize",d.size)}return{update:a}}function ip(t,e,n,i,s){let a=new WeakMap;function r(o){const l=s.render.frame,u=o.geometry,d=e.get(o,u);if(a.get(d)!==l&&(e.update(d),a.set(d,l)),o.isInstancedMesh&&(o.hasEventListener("dispose",c)===!1&&o.addEventListener("dispose",c),a.get(o)!==l&&(n.update(o.instanceMatrix,t.ARRAY_BUFFER),o.instanceColor!==null&&n.update(o.instanceColor,t.ARRAY_BUFFER),a.set(o,l))),o.isSkinnedMesh){const h=o.skeleton;a.get(h)!==l&&(h.update(),a.set(h,l))}return d}function f(){a=new WeakMap}function c(o){const l=o.target;l.removeEventListener("dispose",c),i.releaseStatesOfObject(l),n.remove(l.instanceMatrix),l.instanceColor!==null&&n.remove(l.instanceColor)}return{update:r,dispose:f}}const sp={[Bl]:"LINEAR_TONE_MAPPING",[Ll]:"REINHARD_TONE_MAPPING",[Il]:"CINEON_TONE_MAPPING",[Dl]:"ACES_FILMIC_TONE_MAPPING",[Ul]:"AGX_TONE_MAPPING",[Nl]:"NEUTRAL_TONE_MAPPING",[xl]:"CUSTOM_TONE_MAPPING"};function ap(t,e,n,i,s){const a=new pn(e,n,{type:t,depthBuffer:i,stencilBuffer:s,depthTexture:i?new Ii(e,n):void 0}),r=new pn(e,n,{type:wn,depthBuffer:!1,stencilBuffer:!1}),f=new sn;f.setAttribute("position",new Nt([-1,3,0,-1,-1,0,3,-1,0],3)),f.setAttribute("uv",new Nt([0,2,0,0,2,0],2));const c=new $f({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),o=new pt(f,c),l=new to(-1,1,1,-1,0,1);let u=null,d=null,h=!1,p,g=null,m=[],S=!1;this.setSize=function(y,E){a.setSize(y,E),r.setSize(y,E);for(let T=0;T<m.length;T++){const A=m[T];A.setSize&&A.setSize(y,E)}},this.setEffects=function(y){m=y,S=m.length>0&&m[0].isRenderPass===!0;const E=a.width,T=a.height;for(let A=0;A<m.length;A++){const R=m[A];R.setSize&&R.setSize(E,T)}},this.begin=function(y,E){if(h||y.toneMapping===hn&&m.length===0)return!1;if(g=E,E!==null){const T=E.width,A=E.height;(a.width!==T||a.height!==A)&&this.setSize(T,A)}return S===!1&&y.setRenderTarget(a),p=y.toneMapping,y.toneMapping=hn,!0},this.hasRenderPass=function(){return S},this.end=function(y,E){y.toneMapping=p,h=!0;let T=a,A=r;for(let R=0;R<m.length;R++){const w=m[R];if(w.enabled!==!1&&(w.render(y,A,T,E),w.needsSwap!==!1)){const _=T;T=A,A=_}}if(u!==y.outputColorSpace||d!==y.toneMapping){u=y.outputColorSpace,d=y.toneMapping,c.defines={},Ve.getTransfer(u)===et&&(c.defines.SRGB_TRANSFER="");const R=sp[d];R&&(c.defines[R]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=T.texture,y.setRenderTarget(g),y.render(o,l),g=null,h=!1},this.isCompositing=function(){return h},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),r.dispose(),f.dispose(),c.dispose()}}const oc=new Dt,Ur=new Ii(1,1),lc=new ql,cc=new Ef,fc=new Ql,il=[],sl=[],al=new Float32Array(16),rl=new Float32Array(9),ol=new Float32Array(4);function Fi(t,e,n){const i=t[0];if(i<=0||i>0)return t;const s=e*n;let a=il[s];if(a===void 0&&(a=new Float32Array(s),il[s]=a),e!==0){i.toArray(a,0);for(let r=1,f=0;r!==e;++r)f+=n,t[r].toArray(a,f)}return a}function Et(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function Rt(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function sa(t,e){let n=sl[e];n===void 0&&(n=new Int32Array(e),sl[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function rp(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function op(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Et(n,e))return;t.uniform2fv(this.addr,e),Rt(n,e)}}function lp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Et(n,e))return;t.uniform3fv(this.addr,e),Rt(n,e)}}function cp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Et(n,e))return;t.uniform4fv(this.addr,e),Rt(n,e)}}function fp(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Et(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),Rt(n,e)}else{if(Et(n,i))return;ol.set(i),t.uniformMatrix2fv(this.addr,!1,ol),Rt(n,i)}}function dp(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Et(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),Rt(n,e)}else{if(Et(n,i))return;rl.set(i),t.uniformMatrix3fv(this.addr,!1,rl),Rt(n,i)}}function up(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Et(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),Rt(n,e)}else{if(Et(n,i))return;al.set(i),t.uniformMatrix4fv(this.addr,!1,al),Rt(n,i)}}function hp(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function pp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Et(n,e))return;t.uniform2iv(this.addr,e),Rt(n,e)}}function mp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Et(n,e))return;t.uniform3iv(this.addr,e),Rt(n,e)}}function Sp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Et(n,e))return;t.uniform4iv(this.addr,e),Rt(n,e)}}function gp(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function vp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Et(n,e))return;t.uniform2uiv(this.addr,e),Rt(n,e)}}function _p(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Et(n,e))return;t.uniform3uiv(this.addr,e),Rt(n,e)}}function yp(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Et(n,e))return;t.uniform4uiv(this.addr,e),Rt(n,e)}}function bp(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s);let a;this.type===t.SAMPLER_2D_SHADOW?(Ur.compareFunction=n.isReversedDepthBuffer()?Jr:$r,a=Ur):a=oc,n.setTexture2D(e||a,s)}function Mp(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture3D(e||cc,s)}function Tp(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTextureCube(e||fc,s)}function Hp(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture2DArray(e||lc,s)}function Ep(t){switch(t){case 5126:return rp;case 35664:return op;case 35665:return lp;case 35666:return cp;case 35674:return fp;case 35675:return dp;case 35676:return up;case 5124:case 35670:return hp;case 35667:case 35671:return pp;case 35668:case 35672:return mp;case 35669:case 35673:return Sp;case 5125:return gp;case 36294:return vp;case 36295:return _p;case 36296:return yp;case 35678:case 36198:case 36298:case 36306:case 35682:return bp;case 35679:case 36299:case 36307:return Mp;case 35680:case 36300:case 36308:case 36293:return Tp;case 36289:case 36303:case 36311:case 36292:return Hp}}function Rp(t,e){t.uniform1fv(this.addr,e)}function Pp(t,e){const n=Fi(e,this.size,2);t.uniform2fv(this.addr,n)}function Ap(t,e){const n=Fi(e,this.size,3);t.uniform3fv(this.addr,n)}function Cp(t,e){const n=Fi(e,this.size,4);t.uniform4fv(this.addr,n)}function wp(t,e){const n=Fi(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function Bp(t,e){const n=Fi(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function Lp(t,e){const n=Fi(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function Ip(t,e){t.uniform1iv(this.addr,e)}function Dp(t,e){t.uniform2iv(this.addr,e)}function xp(t,e){t.uniform3iv(this.addr,e)}function Up(t,e){t.uniform4iv(this.addr,e)}function Np(t,e){t.uniform1uiv(this.addr,e)}function Op(t,e){t.uniform2uiv(this.addr,e)}function Fp(t,e){t.uniform3uiv(this.addr,e)}function kp(t,e){t.uniform4uiv(this.addr,e)}function Gp(t,e,n){const i=this.cache,s=e.length,a=sa(n,s);Et(i,a)||(t.uniform1iv(this.addr,a),Rt(i,a));let r;this.type===t.SAMPLER_2D_SHADOW?r=Ur:r=oc;for(let f=0;f!==s;++f)n.setTexture2D(e[f]||r,a[f])}function Wp(t,e,n){const i=this.cache,s=e.length,a=sa(n,s);Et(i,a)||(t.uniform1iv(this.addr,a),Rt(i,a));for(let r=0;r!==s;++r)n.setTexture3D(e[r]||cc,a[r])}function zp(t,e,n){const i=this.cache,s=e.length,a=sa(n,s);Et(i,a)||(t.uniform1iv(this.addr,a),Rt(i,a));for(let r=0;r!==s;++r)n.setTextureCube(e[r]||fc,a[r])}function Xp(t,e,n){const i=this.cache,s=e.length,a=sa(n,s);Et(i,a)||(t.uniform1iv(this.addr,a),Rt(i,a));for(let r=0;r!==s;++r)n.setTexture2DArray(e[r]||lc,a[r])}function Vp(t){switch(t){case 5126:return Rp;case 35664:return Pp;case 35665:return Ap;case 35666:return Cp;case 35674:return wp;case 35675:return Bp;case 35676:return Lp;case 5124:case 35670:return Ip;case 35667:case 35671:return Dp;case 35668:case 35672:return xp;case 35669:case 35673:return Up;case 5125:return Np;case 36294:return Op;case 36295:return Fp;case 36296:return kp;case 35678:case 36198:case 36298:case 36306:case 35682:return Gp;case 35679:case 36299:case 36307:return Wp;case 35680:case 36300:case 36308:case 36293:return zp;case 36289:case 36303:case 36311:case 36292:return Xp}}class Yp{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=Ep(n.type)}}class qp{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=Vp(n.type)}}class Kp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const s=this.seq;for(let a=0,r=s.length;a!==r;++a){const f=s[a];f.setValue(e,n[f.id],i)}}}const Fa=/(\w+)(\])?(\[|\.)?/g;function ll(t,e){t.seq.push(e),t.map[e.id]=e}function $p(t,e,n){const i=t.name,s=i.length;for(Fa.lastIndex=0;;){const a=Fa.exec(i),r=Fa.lastIndex;let f=a[1];const c=a[2]==="]",o=a[3];if(c&&(f=f|0),o===void 0||o==="["&&r+2===s){ll(n,o===void 0?new Yp(f,t,e):new qp(f,t,e));break}else{let u=n.map[f];u===void 0&&(u=new Kp(f),ll(n,u)),n=u}}}class Vs{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const f=e.getActiveUniform(n,r),c=e.getUniformLocation(n,f.name);$p(f,c,this)}const s=[],a=[];for(const r of this.seq)r.type===e.SAMPLER_2D_SHADOW||r.type===e.SAMPLER_CUBE_SHADOW||r.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(r):a.push(r);s.length>0&&(this.seq=s.concat(a))}setValue(e,n,i,s){const a=this.map[n];a!==void 0&&a.setValue(e,i,s)}setOptional(e,n,i){const s=n[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,n,i,s){for(let a=0,r=n.length;a!==r;++a){const f=n[a],c=i[f.id];c.needsUpdate!==!1&&f.setValue(e,c.value,s)}}static seqWithValue(e,n){const i=[];for(let s=0,a=e.length;s!==a;++s){const r=e[s];r.id in n&&i.push(r)}return i}}function cl(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const Jp=37297;let jp=0;function Zp(t,e){const n=t.split(`
`),i=[],s=Math.max(e-6,0),a=Math.min(e+6,n.length);for(let r=s;r<a;r++){const f=r+1;i.push(`${f===e?">":" "} ${f}: ${n[r]}`)}return i.join(`
`)}const fl=new xe;function Qp(t){Ve._getMatrix(fl,Ve.workingColorSpace,t);const e=`mat3( ${fl.elements.map(n=>n.toFixed(4))} )`;switch(Ve.getTransfer(t)){case Js:return[e,"LinearTransferOETF"];case et:return[e,"sRGBTransferOETF"];default:return Be("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function dl(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),a=(t.getShaderInfoLog(e)||"").trim();if(i&&a==="")return"";const r=/ERROR: 0:(\d+)/.exec(a);if(r){const f=parseInt(r[1]);return n.toUpperCase()+`

`+a+`

`+Zp(t.getShaderSource(e),f)}else return a}function e0(t,e){const n=Qp(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const t0={[Bl]:"Linear",[Ll]:"Reinhard",[Il]:"Cineon",[Dl]:"ACESFilmic",[Ul]:"AgX",[Nl]:"Neutral",[xl]:"Custom"};function n0(t,e){const n=t0[e];return n===void 0?(Be("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Ds=new k;function i0(){Ve.getLuminanceCoefficients(Ds);const t=Ds.x.toFixed(4),e=Ds.y.toFixed(4),n=Ds.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function s0(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ji).join(`
`)}function a0(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function r0(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const a=t.getActiveAttrib(e,s),r=a.name;let f=1;a.type===t.FLOAT_MAT2&&(f=2),a.type===t.FLOAT_MAT3&&(f=3),a.type===t.FLOAT_MAT4&&(f=4),n[r]={type:a.type,location:t.getAttribLocation(e,r),locationSize:f}}return n}function Ji(t){return t!==""}function ul(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function hl(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const o0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Nr(t){return t.replace(o0,c0)}const l0=new Map;function c0(t,e){let n=Oe[e];if(n===void 0){const i=l0.get(e);if(i!==void 0)n=Oe[i],Be('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Nr(n)}const f0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function pl(t){return t.replace(f0,d0)}function d0(t,e,n,i){let s="";for(let a=parseInt(e);a<parseInt(n);a++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return s}function ml(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}const u0={[ks]:"SHADOWMAP_TYPE_PCF",[$i]:"SHADOWMAP_TYPE_VSM"};function h0(t){return u0[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const p0={[oi]:"ENVMAP_TYPE_CUBE",[Li]:"ENVMAP_TYPE_CUBE",[ta]:"ENVMAP_TYPE_CUBE_UV"};function m0(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":p0[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const S0={[Li]:"ENVMAP_MODE_REFRACTION"};function g0(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":S0[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const v0={[wl]:"ENVMAP_BLENDING_MULTIPLY",[sf]:"ENVMAP_BLENDING_MIX",[af]:"ENVMAP_BLENDING_ADD"};function _0(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":v0[t.combine]||"ENVMAP_BLENDING_NONE"}function y0(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function b0(t,e,n,i){const s=t.getContext(),a=n.defines;let r=n.vertexShader,f=n.fragmentShader;const c=h0(n),o=m0(n),l=g0(n),u=_0(n),d=y0(n),h=s0(n),p=a0(a),g=s.createProgram();let m,S,y=n.glslVersion?"#version "+n.glslVersion+`
`:"";n.isRawShaderMaterial?(m=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,p].filter(Ji).join(`
`),m.length>0&&(m+=`
`),S=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,p].filter(Ji).join(`
`),S.length>0&&(S+=`
...
void main() {
  ...
  `,t.appendChild(m);const S=m.querySelector("#theme-toggle");S&&S.addEventListener("click",()=>{const _=document.documentElement.classList.toggle("light-mode"),M=_?"light":"dark";document.documentElement.setAttribute("data-theme",M),localStorage.setItem("codenest_theme",M);const L=S.querySelector("#theme-icon");L&&(L.textContent=_?"☀️":"🌙"),document.dispatchEvent(new CustomEvent("themeChanged",{detail:M}))});const y=m.querySelector("#mapContainer");en.forEach((_,M)=>{iS(y,_)});let E=0;const T=m.querySelector("#worldMapBgCanvas"),A=m.querySelector(".world-map-frame");function R(){if(E++,T&&A){const _=A.getBoundingClientRect(),M=Math.floor(_.width/2),L=Math.floor(_.height/2);(T.width!==M||T.height!==L)&&(T.width=M,T.height=L);const x=(document.documentElement.getAttribute("data-theme")||"dark")==="light"?"day":"night";eS(T,E,x)}Or.forEach(_=>{Lm(_.canvas,_.world.theme,_.progress,E)}),ji=requestAnimationFrame(R)}R(),y.addEventListener("click",_=>{!_.target.closest(".island")&&_.target.closest(".island-popover")});const w=localStorage.getItem("codenest_theme")||localStorage.getItem("codenest-theme")||"dark";document.documentElement.setAttribute("data-theme",w),w==="light"?document.documentElement.classList.add("light-mode"):document.documentElement.classList.remove("light-mode")}function iS(t,e,n){const i=Fe.getWorldCompletion(e.id);let a=!Fe.getWorldProgress(e.id).unlocked;const r=document.createElement("div");r.className=`island ${a?"island--locked":""}`,r.dataset.worldId=e.id,r.style.left=`${e.position.x}%`,r.style.top=`${e.position.y}%`;const f=document.createElement("div");f.className="island-visual";const c=document.createElement("canvas");c.width=180,c.height=140,c.className="island-canvas",f.appendChild(c),Or.push({canvas:c,world:e,progress:i});const o=document.createElement("div");o.className="island-label",a?o.innerHTML=`
    ...
    `,r.addEventListener("click",l=>{l.stopPropagation(),Gr(e.id)})),r.appendChild(f),r.appendChild(o),t.appendChild(r)}function sS(){ji&&cancelAnimationFrame(ji);const t=document.querySelector(".hero-avatar-canvas");t&&t._cleanup&&t._cleanup()}class Hl{constructor(e="stack"){this.name=e,this.items=[],this.operations=[]}push(e){return this.items.push(e),this.operations.push({type:"push",item:e,snapshot:[...this.items],timestamp:Date.now()}),e}pop(){if(this.items.length===0)throw new Error(`Stack "${this.name}" is empty! Cannot pop.`);const e=this.items.pop();return this.operations.push({type:"pop",item:e,snapshot:[...this.items],timestamp:Date.now()}),e}peek(){if(this.items.length!==0)return this.items[this.items.length-1]}isEmpty(){return this.items.length===0}size(){return this.items.length}getItems(){return[...this.items]}clear(){this.items=[],this.operations=[]}toString(){return`[${this.items.join(", ")}]`}}function aS(t){const n=t.split(`
`),i=[],s=[0];for(let a=0;a<n.length;a++){let r=n[a];const f=r.trimStart(),c=r.length-f.length;if(f===""||f.startsWith("#")){f.startsWith("#")?i.push(r.replace(/^(\s*)#/,"$1//")):i.push("");continue}for(;s.length>1&&c<=s[s.length-1]-1;)s.pop(),i.push(" ".repeat(s[s.length-1])+"}");let o=f;o=o.replace(/^print\s*\((.*)\)$/g,"console.log($1)"),o=o.replace(/\bprint\s*\(/g,"console.log("),o=o.replace(/f"([^"]*)"/g,(S,y)=>"`"+y.replace(/\{/g,"${")+"`"),o=o.replace(/f'([^']*)'/g,(S,y)=>"`"+y.replace(/\{/g,"${")+"`"),o=o.replace(/\blen\((\w+)\)/g,"$1.length");const l=o.match(/^for\s+(\w+)\s+in\s+range\((.+)\)\s*:$/);if(l){const[,S,y]=l,E=y.split(",").map(T=>T.trim());if(E.length===1)o=`for (let ${S} = 0; ${S} < ${E[0]}; ${S}++) {`;else if(E.length===2)o=`for (let ${S} = ${E[0]}; ${S} < ${E[1]}; ${S}++) {`;else if(E.length===3){const T=E[2];o=`for (let ${S} = ${E[0]}; ${S} < ${E[1]}; ${S} += ${T}) {`}s.push(c+4),i.push(" ".repeat(c)+o);continue}const u=o.match(/^for\s+(\w+)\s+in\s+(.+?)\s*:$/);if(u){const[,S,y]=u;o=`for (const ${S} of ${y}) {`,s.push(c+4),i.push(" ".repeat(c)+o);continue}const d=o.match(/^while\s+(.+?)\s*:$/);if(d){let S=d[1];S=Xa(S),o=`while (${S}) {`,s.push(c+4),i.push(" ".repeat(c)+o);continue}const h=o.match(/^if\s+(.+?)\s*:$/);if(h){let S=h[1];S=Xa(S),o=`if (${S}) {`,s.push(c+4),i.push(" ".repeat(c)+o);continue}const p=o.match(/^elif\s+(.+?)\s*:$/);if(p){let S=p[1];S=Xa(S),i.push(" ".repeat(c)+`} else if (${S}) {`);continue}if(o==="else:"){i.push(" ".repeat(c)+"} else {");continue}const g=o.match(/^def\s+(\w+)\s*\((.*?)\)\s*:$/);if(g){o=`function ${g[1]}(${g[2]}) {`,s.push(c+4),i.push(" ".repeat(c)+o);continue}const m=o.match(/^(\w+)\s*=\s*(.+)$/);m&&!o.includes("==")&&!o.startsWith("stack.")&&!o.startsWith("stack2.")&&!o.startsWith("console.")&&!o.includes(".append(")&&!o.includes(".next")&&(o=`let ${m[1]} = ${m[2]}`),o=o.replace(/\bTrue\b/g,"true"),o=o.replace(/\bFalse\b/g,"false"),o=o.replace(/\bNone\b/g,"null"),o=o.replace(/\.append\(/g,".push("),o=o.replace(/\bnot\s+/g,"!"),o=o.replace(/\band\b/g,"&&"),o=o.replace(/\bor\b/g,"||"),o=o.replace(/\bstr\(/g,"String("),o=o.replace(/\bint\(/g,"parseInt("),!o.endsWith("{")&&!o.endsWith("}")&&!o.startsWith("//")&&o.trim()&&(o=o+";"),i.push(" ".repeat(c)+o)}for(;s.length>1;)s.pop(),i.push("}");return i.join(`
`)}function Xa(t){return t=t.replace(/\bTrue\b/g,"true"),t=t.replace(/\bFalse\b/g,"false"),t=t.replace(/\bNone\b/g,"null"),t=t.replace(/\bnot\s+/g,"!"),t=t.replace(/\band\b/g,"&&"),t=t.replace(/\bor\b/g,"||"),t=t.replace(/\bis\s+null\b/g,"=== null"),t=t.replace(/\bis\s+!null\b/g,"!== null"),t}function rS(t){let e=t;e=e.replace(/import\s+[\w.*]+;\s*/g,"");let n=0;/(?:public\s+)?class\s+\w+\s*\{/.test(e)&&(e=e.replace(/(?:public\s+)?class\s+\w+\s*\{/,""),n++),/public\s+static\s+void\s+main\s*\(.*?\)\s*\{/.test(e)&&(e=e.replace(/public\s+static\s+void\s+main\s*\(.*?\)\s*\{/,""),n++),e=e.replace(/(?:public\s+|private\s+|protected\s+)?(?:static\s+)?(?:void|int|long|float|double|boolean|String|char)\s+(\w+)\s*\(([^)]*)\)\s*\{/g,(i,s,a)=>{const r=a.replace(/\b(?:int|long|float|double|boolean|char|String|byte|short)\s+/g,"").trim();return`function ${s}(${r}) {`}),e=e.replace(/\b(int|long|float|double|boolean|char|byte|short)\s+(\w+)\s*=/g,"let $2 ="),e=e.replace(/\b(int|long|float|double|boolean|char|byte|short)\s+(\w+)\s*;/g,"let $2;"),e=e.replace(/\bString\s+(\w+)\s*=/g,"let $1 ="),e=e.replace(/\bString\s+(\w+)\s*;/g,"let $1;"),e=e.replace(/\bvar\s+/g,"let "),e=e.replace(/\b(?:int|long|float|double|String|char)\[\]\s+(\w+)\s*=\s*(?:new\s+\w+\[\]\s*)?\{([^}]*)\}/g,"let $1 = [$2]"),e=e.replace(/\b(?:int|long|float|double|String|char)\[\]\s+(\w+)\s*=\s*new\s+\w+\[([^\]]+)\]/g,"let $1 = new Array($2).fill(0)"),e=e.replace(/System\.out\.println\s*\(/g,"console.log("),e=e.replace(/System\.out\.print\s*\(/g,"console.log("),e=e.replace(/\.length\(\)/g,".length"),e=e.replace(/(\w+)\.toCharArray\(\)/g,"[...$1]"),e=e.replace(/String\.valueOf\s*\(/g,"String("),e=e.replace(/Integer\.parseInt\s*\(/g,"parseInt("),e=e.replace(/Integer\.valueOf\s*\(/g,"parseInt("),e=e.replace(/([a-zA-Z0-9_.[\]()'"\s]+)\.equals\(([^)]+)\)/g,"$1 === $2"),e=e.replace(/Arrays\.sort\((\w+)\)/g,"$1.sort()"),e=e.replace(/Arrays\.equals\((\w+),\s*(\w+)\)/g,"$1.join() === $2.join()"),e=e.replace(/new\s+String\((\w+)\)/g,'$1.join("")'),e=e.replace(/(?:List|ArrayList)<\w+>\s+(\w+)\s*=\s*new\s+ArrayList<>\(\)/g,"let $1 = []"),e=e.replace(/new\s+ArrayList<>\(\)/g,"[]"),e=e.replace(/\.add\(/g,".push("),e=e.replace(/\.get\((\w+)\)/g,"[$1]"),e=e.replace(/\.size\(\)/g,".length"),e=e.replace(/\.remove\((\w+)\)/g,".splice($1, 1)"),e=e.replace(/Stack<\w+>\s+(\w+)\s*=\s*new\s+Stack<.*?>\(\)/g,"// Using built-in stack object"),e=e.replace(/for\s*\(\s*(int|long)\s+/g,"for (let "),e=e.replace(/for\s*\(\s*(?:int|long|float|double|String|char|var|final)\s+(\w+)\s*:\s*([^)]+)\s*\)/g,"for (const $1 of $2)"),e=e.replace(/\bboolean\s+(\w+)/g,"let $1");for(let i=0;i<n;i++){let s=e.lastIndexOf("}");s!==-1&&(e=e.substring(0,s)+e.substring(s+1))}return e}function oS(t){let e=t;e=e.replace(/#include\s*<[^>]+>\s*/g,""),e=e.replace(/#include\s*"[^"]+"\s*/g,""),e=e.replace(/#define\s+\w+\s+.*/g,""),e=e.replace(/int\s+main\s*\(.*?\)\s*\{/g,""),e=e.replace(/return\s+0\s*;/g,""),e=e.replace(/printf\s*\(\s*"([^"]*)"(?:\s*,\s*(.*?))?\s*\)\s*;/g,(i,s,a)=>{let r=s;const f=a?a.split(",").map(o=>o.trim()):[];let c=0;return r=r.replace(/%d|%i|%ld/g,()=>c<f.length?"${"+f[c++]+"}":""),r=r.replace(/%f|%lf/g,()=>c<f.length?"${"+f[c++]+"}":""),r=r.replace(/%s/g,()=>c<f.length?"${"+f[c++]+"}":""),r=r.replace(/%c/g,()=>c<f.length?"${"+f[c++]+"}":""),r=r.replace(/\\n/g,""),`console.log(\`${r}\`);`}),e=e.replace(/\b(int|long|float|double|char)\s+(\w+)\s*=/g,"let $2 ="),e=e.replace(/\b(int|long|float|double|char)\s+(\w+)\s*;/g,"let $2;"),e=e.replace(/\b(?:int|long|float|double|char)\s+(\w+)\[\d*\]\s*=\s*\{([^}]*)\}/g,"let $1 = [$2]"),e=e.replace(/\b(?:int|long|float|double|char)\s+(\w+)\[(\w+)\]\s*;/g,"let $1 = new Array($2).fill(0)"),e=e.replace(/\bchar\s*\*\s*(\w+)\s*=/g,"let $1 ="),e=e.replace(/sizeof\((\w+)\)\s*\/\s*sizeof\(\w+\[0\]\)/g,"$1.length"),e=e.replace(/strlen\((\w+)\)/g,"$1.length"),e=e.replace(/for\s*\(\s*(int|long)\s+/g,"for (let "),e=e.replace(/\bNULL\b/g,"null"),e=e.replace(/struct\s+\w+\s*\{[^}]*\}\s*;?/g,"");let n=e.lastIndexOf("}");return n!==-1&&(e=e.substring(0,n)+e.substring(n+1)),e}function lS(t,e={}){const n=e.language||"javascript",i=new Hl("stack"),s=new Hl("stack2"),a=[],r=[];let f=performance.now(),c=t;try{n==="python"?c=aS(t):n==="java"?c=rS(t):n==="c"&&(c=oS(t))}catch(l){return{success:!1,stack:i,stack2:s,operations:[],logs:a,errors:[`Transpilation Error (${n}): ${l.message}`],executionTime:0,error:`Transpilation Error: ${l.message}`}}const o={log:(...l)=>{const u=l.map(d=>{if(typeof d=="object")try{return JSON.stringify(d)}catch{return String(d)}return String(d)}).join(" ");a.push(u)},error:(...l)=>{const u=l.map(d=>String(d)).join(" ");r.push(u),a.push(`ERROR: ${u}`)},warn:(...l)=>{const u=l.map(d=>String(d)).join(" ");a.push(`WARN: ${u}`)},info:(...l)=>{const u=l.map(d=>String(d)).join(" ");a.push(`INFO: ${u}`)}};try{new Function("stack","stack2","console","setTimeout","setInterval","fetch","XMLHttpRequest",`
      "use strict";
      ...
      ${c}
      `)(i,s,o,void 0,void 0,void 0,void 0);const u=performance.now(),d=Math.round((u-f)*100)/100;return{success:!0,stack:i,stack2:s,operations:[...i.operations,...s.operations].sort((h,p)=>h.timestamp-p.timestamp),logs:a,errors:r,executionTime:d}}catch(l){const u=performance.now(),d=Math.round((u-f)*100)/100;return{success:!1,stack:i,stack2:s,operations:[...i.operations,...s.operations],logs:a,errors:[...r,l.message],executionTime:d,error:l.message}}}function cS(t,e){try{return t.validate(e.stack,e.operations,{logs:e.logs||[],stack2:e.stack2,success:e.success,error:e.error})}catch(n){return e.success?{passed:!1,message:`Validation Error: ${n.message}`,testsRun:0,testsPassed:0}:{passed:!1,message:`Runtime Error: ${e.error}`,testsRun:0,testsPassed:0}}}function fS(t,e,n,i,s){const r={easy:50,medium:75,hard:100}[t.difficulty]||50,f=i===0?Math.round(r*.5):0,c=e.executionTime<50?Math.round(r*.5):0;let o=r+f+c,l=0;e.operations&&e.operations.length>0&&(l=20);const u=e.operations&&e.operations.length>3?10:0,d=n===0?10:0;let h=l+u+d,p=1;n===0&&i<=1?p=3:n<=1&&i<=3&&(p=2);const g=p===3?1:0,m=p===3&&i===0?1:0;let S=g+m;const y=[];return y.push({label:"Level completed",amount:r,type:"gold"}),f>0&&y.push({label:"No errors",amount:f,type:"gold"}),c>0&&y.push({label:"Fast completion",amount:c,type:"gold"}),l>0&&y.push({label:"Correct data structure usage",amount:l,type:"mana"}),u>0&&y.push({label:"Efficient logic/loops",amount:u,type:"mana"}),d>0&&y.push({label:"No hints used",amount:d,type:"mana"}),g>0&&y.push({label:"3-star performance",amount:g,type:"gem"}),m>0&&y.push({label:"Perfect run",amount:m,type:"gem"}),s&&(o=Math.round(o*.25),h=0,S=0,y.length=0,y.push({label:"Replay bonus",amount:o,type:"gold"})),{gold:o,mana:h,gems:S,stars:p,breakdown:y}}let Lt=null;function dS(){if(!Lt){const t=window.AudioContext||window.webkitAudioContext;t&&(Lt=new t)}Lt&&Lt.state==="suspended"&&Lt.resume()}function uS(t=600){if(!Lt)return;Lt.state==="suspended"&&Lt.resume();const e=Lt.createOscillator(),n=Lt.createGain();e.type="triangle",e.frequency.setValueAtTime(t,Lt.currentTime),e.frequency.exponentialRampToValueAtTime(t*.8,Lt.currentTime+.05),n.gain.setValueAtTime(.05,Lt.currentTime),n.gain.exponentialRampToValueAtTime(.001,Lt.currentTime+.05),e.connect(n),n.connect(Lt.destination),e.start(),e.stop(Lt.currentTime+.05)}let zn=localStorage.getItem("guideMuted")==="true",is="",hc=1;function hS(){return zn=!zn,localStorage.setItem("guideMuted",zn),zn?pc():is&&mc(is,hc),zn}function pc(){window.speechSynthesis&&window.speechSynthesis.cancel()}function mc(t,e=1){if(zn||!window.speechSynthesis)return;pc();const n=new SpeechSynthesisUtterance(t);n.pitch=e,n.rate=1.05,window.speechSynthesis.speak(n)}function Zi(t,e,n,i){t&&(is=t,hc=e,pS(i,t,n),mc(t,e))}function pS(t,e,n){t.innerHTML="";let i="",s=0;t._typewriterTimeout&&clearTimeout(t._typewriterTimeout);function a(){if(s<e.length){const r=e.charAt(s);r==="\\"&&e.charAt(s+1)==="n"?(i+="<br>",s+=2):r===`
`?(i+="<br>",s++):(i+=r,/[a-zA-Z0-9]/.test(r)&&(zn||!window.speechSynthesis)&&(dS(),uS(n)),s++),t.innerHTML=i;const f=/[.,!?]/.test(r)?150:35;t._typewriterTimeout=setTimeout(a,f)}}a()}function Fr(t,e){if(e==="python"&&t.starterCodePython)return t.starterCodePython;if(e==="java"&&t.starterCodeJava)return t.starterCodeJava;if(e==="c"&&t.starterCodeC)return t.starterCodeC;if(e==="javascript")return t.starterCode;const n=t.starterCode;return e==="python"?mS(n):e==="java"?SS(n):e==="c"?gS(n):n}function mS(t){let e=t;return e=e.replace(/;$/gm,""),e=e.replace(/\b(const|let|var)\s+/g,""),e=e.replace(/console\.log\(/g,"print("),e=e.replace(/\/\/(.*)/g,"#$1"),e=e.replace(/\btrue\b/g,"True"),e=e.replace(/\bfalse\b/g,"False"),e=e.replace(/\bnull\b/g,"None"),e=e.replace(/\.push\(/g,".append("),e=e.replace(/(\w+)\.length/g,"len($1)"),e=e.replace(/for\s*\(\s*\w+\s+(\w+)\s*=\s*0\s*;\s*\1\s*<\s*(\w+(?:\.\w+)*)\s*;\s*\1\+\+\s*\)\s*\{/g,"for $1 in range($2):"),e=e.replace(/\s*\{$/gm,":"),e=e.replace(/^\s*\}\s*$/gm,""),e=e.replace(/stack\.append\(/g,"stack.push("),e}function SS(t){let e=t;return e=e.replace(/(?:const|let|var)\s+(\w+)\s*=\s*(\[.*?\])/g,(i,s,a)=>{const r=a.slice(1,-1);return r.match(/^["\u2018]/)?`String[] ${s} = {${r}}`:`int[] ${s} = {${r}}`}),e=e.replace(/(?:const|let|var)\s+(\w+)\s*=\s*"([^"]*)"/g,'String $1 = "$2"'),e=e.replace(/(?:const|let|var)\s+(\w+)\s*=\s*(\d+)/g,"int $1 = $2"),e=e.replace(/(?:const|let|var)\s+(\w+)\s*=\s*""/g,'String $1 = ""'),e=e.replace(/(?:const|let|var)\s+(\w+)/g,"var $1"),e=e.replace(/console\.log\(([^)]+)\)/g,(i,s)=>`System.out.println(${s.split(/,\s*/).join(' + " " + ')})`),e=e.replace(/for\s*\(\s*let\s+/g,"for (int "),e=e.replace(/new\s+Array\((.*?)\)\.fill\((.*?)\)/g,"new int[$1]"),`import java.util.*;
...
}`}function gS(t){let e=`#include <stdio.h>
...
`);return e+=i+`
    return 0;
}`,e}let fn=null,_e=null,Qi=0,Hn="java",De=null,Ui=null,Sc=null,Ni=!1,wi=!1,ss=!1,kt=0,Qs=0,Vn=!1,no=null;function gc(t,e,n){const i=xc(e,parseInt(n));if(!i){t.innerHTML='<div style="padding: 40px; text-align: center; color: white;">Problem not found! <a href="#/">Go Back</a></div>';return}_e=i,Qi=Fe.player.hintsUsed||0,Ui=e,Sc=n,Ni=!1,wi=!1,ss=!1,kt=0,Qs=0,Vn=!1,no=null,Fe.resetHp();const s=t.querySelector(".hero-avatar-canvas");s&&s._cleanup&&s._cleanup(),De&&De.stop(),t.innerHTML="";const a=document.createElement("div");a.className="problem-page fantasy-theme",Yt.find(B=>B.id===Fe.player.selectedHeroId)||Yt[0];const r=Fe.player.avatarDisplay?`<img src="${Fe.player.avatarDisplay}" style="width: 24px; height: 24px; border-radius: 50%; object-fit: cover; border: 1px solid var(--border-color);" />`:'<span style="font-size: 1.2rem;">🧙‍♂️</span>',f=document.createElement("div");f.className="hud-nav",window.self!==window.top&&(f.style.display="none"),f.innerHTML=`
    <a href="/" class="logo-container">
      <img src="/images/dsa_nest_logo.png" alt="Code Nest Logo" style="height: 40px; image-rendering: pixelated; margin-right: 10px;" onerror="this.style.display='none'">
      <span class="logo-text">Code Nest</span>
    </a>
    ...
    <div class="guide-panel">
      ...
      <div class="guide-speech">
        ...
        <div class="guide-controls">
          ...
          <button class="guide-btn" id="btnToggleMute">${zn?"Unmute":"Mute"}</button>
        </div>
      </div>
    </div>
  ...
  `;const g=document.createElement("div");g.className="open-ide-btn",g.id="btnOpenIde",g.innerHTML='<div class="code-icon">💻</div>OPEN<br>IDE',o.appendChild(l),o.appendChild(d),o.appendChild(g),a.appendChild(f),a.appendChild(c),a.appendChild(o),a.appendChild(p),t.appendChild(a);const m=document.getElementById("gameSceneCanvas"),S=()=>{const B=m.parentElement;m.width=B.clientWidth,m.height=B.clientHeight};window.addEventListener("resize",S),S(),De=new Qm(m,e,i.sceneType),De.setRelics(i.relics),De.setHazards(i.hazards||[]);const y=c.querySelector("#hero3DContainer"),E=Yt.find(B=>B.id===Fe.player.selectedHeroId)||Yt[0],T=E.avatarStyle||"#f5c29d";y&&Zs(y,T,120,{mode:"gameplay"});const A=a.querySelector("#theme-toggle");A&&A.addEventListener("click",()=>{const B=document.documentElement.classList.toggle("light-mode"),F=B?"light":"dark";document.documentElement.setAttribute("data-theme",F),localStorage.setItem("codenest_theme",F);const O=A.querySelector("#theme-icon");O&&(O.textContent=B?"☀️":"🌙"),document.dispatchEvent(new CustomEvent("themeChanged",{detail:F}))});const R=c.querySelector("#guideAvatarContainer");R&&Zs(R,T,60,{mode:"static_portrait"});const w=c.querySelector("#guideTextContainer");let _=1,M=600;E.stats.type==="Mage"&&(_=1.5,M=800),E.stats.type==="Warrior"&&(_=.6,M=300),E.stats.type==="Ranger"&&(_=1.2,M=500);const L=c.querySelector("#btnReplayVoice"),P=c.querySelector("#btnToggleMute");if(L&&L.addEventListener("click",()=>{is&&Zi(is,_,M,w)}),P&&P.addEventListener("click",()=>{const B=hS();P.textContent=B?"Unmute":"Mute"}),w){const B=i.guide?i.guide.intro:i.guideText;Zi(B,_,M,w)}window._showGuideMsg=B=>{if(!i.guide)return;const F=i.guide[B];F&&w&&Zi(F,_,M,w)},De.onCharacterUpdate=(B,F,O,ne,ie,ue,Me,Te)=>{if(y){const ke=m.clientWidth,qe=m.clientHeight;y.style.left=`${B*ke}px`,y.style.top=`${F*qe}px`,Te?y.style.display="none":y.style.display="block",y._viewer&&y._viewer.updateState(O,ne,ie,ue,Me)}},De.start(),Hn="java";const x=Fr(i,"java");_S(x),yS(e),bS(i),document.addEventListener("themeChanged",B=>{window.monaco&&fn&&window.monaco.editor.setTheme(B.detail==="light"?"codeNestThemeLight":"codeNestTheme")});const X=B=>{const F=B.detail||1;Fe.takeDamage(F),El();const O=document.querySelector(".fantasy-scene-layer");O&&(O.classList.add("damage-flash"),setTimeout(()=>O.classList.remove("damage-flash"),300)),window._showGuideMsg&&window._showGuideMsg("damage")},q=()=>{Vn||(vS("You ran out of Health! Be careful around hazards."),window._showGuideMsg&&window._showGuideMsg("fail"))};window.removeEventListener("playerDamage",window._damageListener),window.removeEventListener("playerDied",window._deathListener),window._damageListener=X,window._deathListener=q,window.addEventListener("playerDamage",X),window.addEventListener("playerDied",q),El()}function El(){const t=document.getElementById("hpDisplay");if(!t)return;const e=Fe.player.currentHp,n=Fe.player.maxHp;let i="";for(let s=0;s<n;s++)i+=s<e?'<span style="color: #e74c3c;">❤️</span>':'<span style="color: #555; filter: grayscale(100%);">🖤</span>';t.innerHTML=i}function vS(t){if(Vn)return;Vn=!0,De&&De.stop();const e=document.createElement("div");e.className="success-overlay",e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById("btnFailRetry").addEventListener("click",()=>{e.remove(),document.getElementById("btnReset")&&document.getElementById("btnReset").click(),gc(document.querySelector(".app-content"),Ui,Sc)}),document.getElementById("btnFailHint").addEventListener("click",()=>{e.remove(),Vn=!1;const n=document.querySelector(".fantasy-right-panel");n&&n.classList.remove("collapsed");const i=document.querySelector(".hint-header");i&&i.scrollIntoView({behavior:"smooth"})}),document.getElementById("btnFailBack").addEventListener("click",()=>{e.remove(),Gr(Ui)})}function _S(t){if(window.monaco)Rl(t);else{const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js",e.onload=()=>{window.require.config({paths:{vs:"https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.40.0/min/vs"}}),window.require(["vs/editor/editor.main"],function(){Rl(t)})},document.head.appendChild(e)}}function Rl(t){const e=document.getElementById("monaco-container");if(!e)return;window.monaco.editor.defineTheme("codeNestTheme",{base:"vs-dark",inherit:!0,rules:[{background:"1e2133"},{token:"comment",foreground:"6272a4",fontStyle:"italic"},{token:"keyword",foreground:"ff79c6"},{token:"string",foreground:"f1fa8c"},{token:"number",foreground:"bd93f9"}],colors:{"editor.background":"#1e2133","editor.lineHighlightBackground":"#2a314d","editorLineNumber.foreground":"#6272a4","editorIndentGuide.background":"#2a314d"}}),window.monaco.editor.defineTheme("codeNestThemeLight",{base:"vs",inherit:!0,rules:[{background:"f5e6d3"},{token:"",foreground:"5c4033"},{token:"comment",foreground:"b89f81",fontStyle:"italic"},{token:"keyword",foreground:"8b5a2b",fontStyle:"bold"},{token:"string",foreground:"a0522d"},{token:"number",foreground:"cd853f"},{token:"type",foreground:"6b4423"},{token:"identifier",foreground:"5c4033"},{token:"operator",foreground:"8b5a2b"}],colors:{"editor.background":"#f5e6d3","editor.foreground":"#5c4033","editor.lineHighlightBackground":"#e8d4b9","editorLineNumber.foreground":"#a68a6d","editorIndentGuide.background":"#e8d4b9","scrollbarSlider.background":"#d2b48c","scrollbarSlider.hoverBackground":"#b89f81","scrollbarSlider.activeBackground":"#8b5a2b","editorOverviewRuler.border":"#00000000","editor.inactiveSelectionBackground":"#e8d4b9","editor.selectionBackground":"#d2b48c"}});const n=document.documentElement.dataset.theme||"dark";fn=window.monaco.editor.create(e,{value:t,language:"java",theme:n==="light"?"codeNestThemeLight":"codeNestTheme",minimap:{enabled:!1},fontSize:14,fontFamily:"'Fira Code', monospace",lineHeight:24,padding:{top:16,bottom:16},scrollBeyondLastLine:!1,automaticLayout:!0,roundedSelection:!1,automaticLayout:!0})}function kr(){const t=document.getElementById("btnSubmit");t&&(t.disabled=!0),Ni=!1,wi=!1,ss=!1,kt=0}function Os(){console.log("Checking level completion..."),console.log("isCodeCorrect:",Ni,"levelProgress:",kt,"currentHp:",Fe.player.currentHp),Ni&&kt>=100?(console.log("Conditions met! Triggering handleSuccess..."),vc()):console.log("Conditions NOT met for victory.")}function yS(t,e){const n=document.getElementById("btnRun"),i=document.getElementById("btnSubmit"),s=document.getElementById("btnReset"),a=document.getElementById("btnCloseProblem"),r=document.getElementById("btnBackToLevels");n&&n.addEventListener("click",()=>ES()),i&&i.addEventListener("click",()=>RS()),r&&r.addEventListener("click",()=>{Gr(t)}),s&&s.addEventListener("click",()=>{if(fn&&_e){const p=Fr(_e,Hn);fn.setValue(p),so(),kr(),window._showGuideMsg&&window._showGuideMsg("reset")}}),a&&a.addEventListener("click",()=>{const p=document.querySelector(".fantasy-left-panel");p&&p.classList.add("collapsed")});const f=document.querySelector(".view-challenge-tab");f&&f.addEventListener("click",()=>{const p=document.querySelector(".fantasy-left-panel");p&&p.classList.remove("collapsed")});const c=document.getElementById("btnCloseIde"),o=document.getElementById("btnOpenIde"),l=document.querySelector(".fantasy-right-panel");c&&l&&o&&c.addEventListener("click",()=>{l.classList.add("collapsed"),o.classList.add("visible"),window._showGuideMsg&&window._showGuideMsg("closeIde")}),o&&l&&o.addEventListener("click",()=>{l.classList.remove("collapsed"),o.classList.remove("visible"),window._showGuideMsg&&window._showGuideMsg("openIde")});const u=document.querySelectorAll(".lang-tab");u.forEach(p=>{p.addEventListener("click",g=>{const m=g.currentTarget.getAttribute("data-lang");if(u.forEach(T=>T.classList.remove("lang-tab--active")),g.currentTarget.classList.add("lang-tab--active"),Hn=m,fn){const T=m==="c"?"c":m==="java"?"java":m==="python"?"python":"javascript";if(window.monaco.editor.setModelLanguage(fn.getModel(),T),_e){const A=Fr(_e,m);fn.setValue(A)}}kr();const S={java:"Java",python:"Python",c:"C"};Pn(`Switched to ${S[m]}`,"info");const y=`Ah, switching to ${S[m]}! A fine choice of language for solving this algorithm.`,E=document.getElementById("guideTextContainer");if(E){let T=1,A=600;const R=Yt.find(w=>w.id===Fe.player.selectedHeroId)||Yt[0];R&&(R.stats.type==="Mage"&&(T=1.5,A=800),R.stats.type==="Warrior"&&(T=.6,A=300),R.stats.type==="Ranger"&&(T=1.2,A=500)),Zi(y,T,A,E)}})});const d=document.getElementById("btnThemeToggle"),h=document.getElementById("themeToggleIcon");d&&h&&d.addEventListener("click",()=>{const g=document.documentElement.dataset.theme==="light"?"dark":"light";document.documentElement.dataset.theme=g,localStorage.setItem("theme",g),h.textContent=g==="light"?"☀️":"🌙",document.dispatchEvent(new CustomEvent("themeChanged",{detail:g}))}),window._showGuideMsg=p=>{var S,y,E;let g=p;_e&&_e.guide&&_e.guide[p]?g=_e.guide[p]:p==="damage"?g=((S=_e==null?void 0:_e.guide)==null?void 0:S.damage)||"Ouch! You took damage from a hazard. Check your logic and paths to avoid the traps!":p==="fail"?g=((y=_e==null?void 0:_e.guide)==null?void 0:y.fail)||"Oh no, you ran out of health and fell! Do not worry—reset the level, refine your algorithm, and try again.":p==="reset"?g="Resetting the editor. Let us start fresh and craft a perfect solution!":p==="closeIde"?g="IDE closed. You can focus on the path ahead, and open it back up when you are ready to code.":p==="openIde"?g="IDE opened. Let us refine the code and solve this puzzle!":p==="runStart"?g="Compiling and running your code... Let us see if our logic holds up in the arena!":p==="runError"?g="Ah, a compilation or runtime error! Check the console output below to pinpoint the issue.":p==="runSuccess"?g="Excellent! The code ran successfully and matched all tests. Let us submit the solution to proceed!":p==="runFailTests"?g="The code ran, but the tests failed. Look at the failed test details in the console or unlock a hint!":p==="levelSuccess"?g=((E=_e==null?void 0:_e.guide)==null?void 0:E.success)||"Outstanding job! You solved the puzzle and completed the level! Continue to the next challenge.":p==="codeHint"&&(g="Here is a hint to guide you on the right path.");const m=document.getElementById("guideTextContainer");if(m&&g){let T=1,A=600;const R=Yt.find(w=>w.id===Fe.player.selectedHeroId)||Yt[0];R&&(R.stats.type==="Mage"&&(T=1.5,A=800),R.stats.type==="Warrior"&&(T=.6,A=300),R.stats.type==="Ranger"&&(T=1.2,A=500)),Zi(g,T,A,m)}},setTimeout(()=>{window._showGuideMsg&&window._showGuideMsg("intro")},800)}function bS(t){let e=0;const n=t.hints||[],i=document.querySelector(".hint-title"),s=document.querySelector(".hint-cost"),a=document.getElementById("hintText"),r=document.getElementById("prevHint"),f=document.getElementById("nextHint");function c(){if(n.length===0)return;const o=n[e];i.innerHTML=`💡 HINT (${e+1}/${n.length})`,e<=Qi?(s.innerHTML="Unlocked",s.style.color="var(--emerald)",a.innerHTML=o.text,a.style.filter="none"):(s.innerHTML=`Cost: ${o.cost} Mana`,s.style.color="var(--sapphire)",a.innerHTML="Click to unlock this hint.",a.style.filter="blur(2px)",a.style.cursor="pointer",a.onclick=()=>{const l=Ys(Ui,_e.id);fetch("/api/game/buy-hint",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({levelId:l,hintIndex:e,cost:o.cost})}).then(u=>u.ok?u.json():u.text().then(d=>{throw new Error(d)})).then(u=>{if(u&&u.success){Qi=e,Fe.player.hintsUsed=Qi,u.user&&(Fe.mapBackendUserToState(u.user),Fe.saveToLocalStorageOnly()),c();const d=document.querySelector(".mana-val");d&&(d.textContent=Fe.player.mana.toLocaleString()),Pn(`Hint unlocked for ${o.cost} Mana!`,"success"),window._showGuideMsg&&window._showGuideMsg("codeHint")}}).catch(u=>{Pn(u.message||"Failed to buy hint!","error")})}),n.length<=1?(r.style.display="none",f.style.display="none"):(r.style.display="block",f.style.display="block",r.disabled=e===0,f.disabled=e===n.length-1)}r.addEventListener("click",()=>{e>0&&(e--,a.onclick=null,c())}),f.addEventListener("click",()=>{e<n.length-1&&(e++,a.onclick=null,c())}),c()}function Mt(t,e="info"){const n=document.getElementById("consoleOutput"),i=document.createElement("div");i.className=`console-line console-line--${e}`,i.textContent="> "+t,n.appendChild(i),n.scrollTop=n.scrollHeight}function MS(){const t=document.getElementById("consoleOutput");t.innerHTML=""}function io(t){De&&De.updateStack(t||[]);const e=document.getElementById("stackViz");if(e.innerHTML="",!t||t.length===0){e.innerHTML='<div class="stack-empty-text">-- Empty --</div>';const i=document.querySelector(".stack-top-label");i&&(i.textContent="--");return}t.forEach((i,s)=>{const a=document.createElement("div");a.className="stack-item stack-item--animate",s===t.length-1&&a.classList.add("stack-item--top"),a.textContent=typeof i=="object"?JSON.stringify(i):String(i),a.style.animationDelay=`${s*.08}s`,e.appendChild(a)});const n=document.querySelector(".stack-top-label");if(n){const i=t[t.length-1];n.textContent=`TOP: ${typeof i=="object"?JSON.stringify(i):String(i)}`}}function so(){var e;MS(),Mt("Ready for execution.","info"),io([]),De&&(De.isExitOpen=!1,De.collectedRelics.clear(),De.resetCharacter());const t=document.getElementById("hero3DContainer");t&&(t.style.display="block",t._viewer&&t._viewer.resetIdle&&t._viewer.resetIdle()),document.getElementById("relicsCount").textContent=`0 / ${((e=_e==null?void 0:_e.relics)==null?void 0:e.length)||0}`,document.getElementById("sceneProgress").style.width="0%",document.getElementById("sceneProgressText").textContent="0%"}function TS(t,e,n){const i=[];_e.levelActionConfig;const s=n*.35,a=n*.5,r=n*.65,f=new Set;for(const c of t)if(c.type==="push"){const o=c.item,l=e.findIndex((u,d)=>u.name===o&&!f.has(d));if(l!==-1){f.add(l);const u=e[l],d=u.x/100*n;i.push({type:"MOVE_TO",targetX:d,label:o}),i.push({type:"WAIT",frames:10}),i.push({type:"PICKUP",item:o,itemId:u.id||u.name})}i.push({type:"MOVE_TO",targetX:a,label:"stack_tower"}),i.push({type:"WAIT",frames:5}),i.push({type:"EXECUTE_CALLBACK",callback:()=>Mt(`push(${JSON.stringify(o)})`,"info")}),i.push({type:"INSERT_STACK",item:o})}else c.type==="pop"?(i.push({type:"MOVE_TO",targetX:r,label:"pop_machine"}),i.push({type:"WAIT",frames:5}),i.push({type:"EXECUTE_CALLBACK",callback:()=>Mt(`pop() → ${JSON.stringify(c.item)}`,"warning")}),i.push({type:"POP_ITEM",item:c.item}),i.push({type:"WAIT",frames:8})):c.type==="peek"&&(i.push({type:"MOVE_TO",targetX:s,label:"peek_shrine"}),i.push({type:"WAIT",frames:5}),i.push({type:"EXECUTE_CALLBACK",callback:()=>Mt(`peek() → ${JSON.stringify(c.item)}`,"info")}),i.push({type:"PEEK_ITEM",item:c.item}));return i}function HS(t,e,n){const i=[],s=new Set,a=_e.levelActionConfig;if(_e.id===2&&_e.worldId==="arrays-strings"){const f=[];for(const c of t){const o=c.match(/\d+/g);o&&o.forEach(l=>{const u=parseInt(l);u>=0&&u<e.length&&f.push(u)})}return f.includes(0)&&f.includes(2)&&(i.push({type:"JUMP_TO",targetX:e[0].x/100*n,targetY:e[0].y,waitMs:600,label:"check_0"}),i.push({type:"WAIT",frames:30}),i.push({type:"JUMP_TO",targetX:e[1].x/100*n,targetY:e[1].y,waitMs:600,label:"check_1"}),i.push({type:"WAIT",frames:30}),i.push({type:"JUMP_TO",targetX:e[0].x/100*n,targetY:e[0].y,waitMs:600,label:"check_0"}),i.push({type:"WAIT",frames:30}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:e[0].x/100*n,item:e[0].name,itemId:e[0].id||e[0].name}):i.push({type:"PICKUP",item:e[0].name,itemId:e[0].id||e[0].name}),s.add(e[0].name),i.push({type:"JUMP_TO",targetX:e[2].x/100*n,targetY:e[2].y,waitMs:600,label:"check_2"}),i.push({type:"WAIT",frames:30}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:e[2].x/100*n,item:e[2].name,itemId:e[2].id||e[2].name}):i.push({type:"PICKUP",item:e[2].name,itemId:e[2].id||e[2].name}),s.add(e[2].name)),f.forEach(c=>{const o=e[c];if(o&&!s.has(o.name)){s.add(o.name);const l=o.x/100*n;i.push({type:"JUMP_TO",targetX:l,targetY:o.y,waitMs:600,label:o.name}),i.push({type:"WAIT",frames:30}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:l,item:o.name,itemId:o.id||o.name}):i.push({type:"PICKUP",item:o.name,itemId:o.id||o.name})}}),i}if(_e.id===3&&_e.worldId==="arrays-strings"&&t.some(c=>c.includes("15")))return[1,2,3].forEach(o=>{const l=e[o];if(!s.has(l.name)){s.add(l.name);const u=l.x/100*n;i.push({type:"JUMP_TO",targetX:u,targetY:l.y,waitMs:600,label:l.name}),i.push({type:"WAIT",frames:30}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:u,item:l.name,itemId:l.id||l.name}):i.push({type:"PICKUP",item:l.name,itemId:l.id||l.name})}}),i;if(_e.id===4&&_e.worldId==="arrays-strings"&&t.some(c=>c.includes("YES"))){const c=[0,4,1,3,2];return c.forEach(o=>{i.push({type:"JUMP_TO",targetX:e[o].x/100*n,waitMs:600,label:e[o].name}),i.push({type:"WAIT",frames:20})}),c.forEach(o=>{const l=e[o];s.has(l.name)||(s.add(l.name),i.push({type:"JUMP_TO",targetX:l.x/100*n,waitMs:400}),i.push({type:"WAIT",frames:10}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:l.x/100*n,item:l.name,itemId:l.id||l.name}):i.push({type:"PICKUP",item:l.name,itemId:l.id||l.name}))}),i}if(_e.id===5&&_e.worldId==="arrays-strings"&&t.some(c=>c.toUpperCase().includes("TRUE")))return i.push({type:"JUMP_TO",targetX:e[0].x/100*n,targetY:e[0].y,waitMs:600,label:"check_0"}),i.push({type:"WAIT",frames:40}),i.push({type:"JUMP_TO",targetX:e[1].x/100*n,targetY:e[1].y,waitMs:600,label:"check_1"}),i.push({type:"WAIT",frames:40}),[0,1].forEach(c=>{const o=e[c];s.has(o.name)||(s.add(o.name),i.push({type:"JUMP_TO",targetX:o.x/100*n,targetY:o.y,waitMs:400}),i.push({type:"WAIT",frames:10}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:o.x/100*n,targetY:o.y,item:o.name,itemId:o.id||o.name}):i.push({type:"PICKUP",item:o.name,itemId:o.id||o.name}))}),i;if(_e.id===6&&_e.worldId==="arrays-strings"&&t.join(" ").includes("1")&&t.join(" ").includes("3"))return[0,1,2,3].forEach(c=>{const o=e[c];i.push({type:"JUMP_TO",targetX:o.x/100*n,waitMs:500,label:"check_"+c}),i.push({type:"WAIT",frames:20}),c!==2&&(s.add(o.name),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:o.x/100*n,item:o.name,itemId:o.id||o.name}):i.push({type:"PICKUP",item:o.name,itemId:o.id||o.name}))}),i;if(_e.id===7&&_e.worldId==="arrays-strings"&&t.some(c=>c.includes("42")))return[0,1,2,1].forEach((c,o)=>{const l=e[c];i.push({type:"JUMP_TO",targetX:l.x/100*n,waitMs:600,label:"check_"+c}),i.push({type:"WAIT",frames:30}),o===3&&(s.add(l.name),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:l.x/100*n,item:l.name,itemId:l.id||l.name}):i.push({type:"PICKUP",item:l.name,itemId:l.id||l.name}))}),i;if(_e.id===8&&_e.worldId==="arrays-strings"&&t.join(" ").includes("TULIP"))return[2,1,0].forEach(c=>{const o=e[c];i.push({type:"JUMP_TO",targetX:o.x/100*n,waitMs:600}),i.push({type:"WAIT",frames:20}),s.add(o.name),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:o.x/100*n,item:o.name,itemId:o.id||o.name}):i.push({type:"PICKUP",item:o.name,itemId:o.id||o.name})}),i;if(_e.id===9&&_e.worldId==="arrays-strings"&&t.some(c=>c.includes("3"))){[0,1].forEach(o=>{const l=e[o];i.push({type:"JUMP_TO",targetX:l.x/100*n,waitMs:500}),i.push({type:"WAIT",frames:20}),s.add(l.name),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:l.x/100*n,item:l.name,itemId:l.id||l.name}):i.push({type:"PICKUP",item:l.name,itemId:l.id||l.name})});const c=80/100*n;return i.push({type:"JUMP_TO",targetX:c,waitMs:600}),i.push({type:"WAIT",frames:40}),a&&i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:c,item:"3",itemId:"3"}),i}if(_e.id===10&&_e.worldId==="arrays-strings"&&t.some(c=>c.includes("3")))return[0,1,2,3].forEach((c,o)=>{const l=e[c];i.push({type:"JUMP_TO",targetX:l.x/100*n,waitMs:500}),i.push({type:"WAIT",frames:o===3?60:20}),o<3&&(s.add(l.name+"_"+o),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:l.x/100*n,item:l.name,itemId:l.id||l.name}):i.push({type:"PICKUP",item:l.name,itemId:l.id||l.name}))}),i;const r=[];t.forEach((f,c)=>{e.forEach(o=>{let l=0;for(;;){const u=f.indexOf(o.name,l);if(u===-1)break;r.push({relic:o,logIdx:c,charIdx:u}),l=u+o.name.length}})}),r.sort((f,c)=>f.logIdx!==c.logIdx?f.logIdx-c.logIdx:f.charIdx-c.charIdx);for(const f of r){const c=f.relic;if(!s.has(c.name)){s.add(c.name);const o=c.x/100*n;i.push({type:"JUMP_TO",targetX:o,targetY:c.y,waitMs:600,label:c.name}),i.push({type:"WAIT",frames:30}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:o,item:c.name,itemId:c.id||c.name}):i.push({type:"PICKUP",item:c.name,itemId:c.id||c.name})}}if(i.length===0&&e.length>0){const f=e[0],c=f.x/100*n;i.push({type:"JUMP_TO",targetX:c,targetY:f.y,waitMs:600,label:f.name}),i.push({type:"WAIT",frames:30}),a?i.push({type:"USE_TOOL",tool:a.requiredTool,animation:a.actionAnimation,effect:a.successEffect,targetX:c,item:f.name}):i.push({type:"PICKUP",item:f.name})}return i}function Pl(t,e,n=[]){if(!De){t.stack&&io(t.stack.getItems()),Va(t),wi=!0,e&&Os();return}let i=!1;if(De.lastProcessedLogs){const o=De.lastProcessedLogs;if(t.logs.length<o.length)i=!0;else for(let l=0;l<o.length;l++)if(t.logs[l]!==o[l]){i=!0;break}}if(De.lastProcessedOps&&!i){const o=De.lastProcessedOps;if(t.operations&&t.operations.length<o.length)i=!0;else if(t.operations){for(let l=0;l<o.length;l++)if(t.operations[l].type!==o[l].type||t.operations[l].item!==o[l].item){i=!0;break}}}i&&so();const s=_e.relics||[],a=De.canvas.width;let r=[];const f=De.lastProcessedOps&&!i?De.lastProcessedOps.length:0,c=De.lastProcessedLogs&&!i?De.lastProcessedLogs.length:0;if(t.operations&&t.operations.length>f){const o=t.operations.slice(f);r=TS(o,s,a)}if(r.length===0&&t.logs&&t.logs.length>c){const o=t.logs.slice(c);r=HS(o,s,a)}if(De.lastProcessedLogs=[...t.logs],t.operations&&(De.lastProcessedOps=[...t.operations]),e?(r.push({type:"MOVE_TO",targetX:a*.82,label:"exit_door"}),r.push({type:"WAIT",frames:10}),r.push({type:"ENTER_DOOR"}),no=t):n&&n.length>0&&r.push(...n),r.length===0){Va(t),wi=!0,e?(Os(),window._showGuideMsg&&window._showGuideMsg("successMessage")):window._showGuideMsg&&window._showGuideMsg("errorHint");return}Mt("Executing commands...","info"),De.onDoorEnter=()=>{kt=100,document.getElementById("sceneProgress").style.width=`${kt}%`,document.getElementById("sceneProgressText").textContent=`${kt}%`,Os()},De.enqueueCommands(r,()=>{Mt(`Execution completed in ${t.executionTime}ms`,"success"),Va(t),wi=!0,e?(kt=100,document.getElementById("sceneProgress").style.width=`${kt}%`,document.getElementById("sceneProgressText").textContent=`${kt}%`,Os(),window._showGuideMsg&&window._showGuideMsg("successMessage")):(document.getElementById("sceneProgress").style.width=`${kt}%`,document.getElementById("sceneProgressText").textContent=`${kt}%`,window._showGuideMsg&&window._showGuideMsg("errorHint"))})}function Va(t){var s;if(!_e.relics){ss=!0,kt=100;return}const e=t.logs||[],n=t.stack?t.stack.getItems():[];let i=0;if(_e.id===2&&_e.worldId==="arrays-strings"){const a=[];for(const r of e){const f=r.match(/\d+/g);f&&f.forEach(c=>{const o=parseInt(c);o>=0&&o<_e.relics.length&&a.push(o)})}_e.relics.forEach((r,f)=>{a.includes(f)&&(De&&De.collectRelic(r.id||r.name),i++)})}else if(_e.id===3&&_e.worldId==="arrays-strings"){if(e.some(r=>r.includes("15"))){const r=[1,2,3];_e.relics.forEach((f,c)=>{r.includes(c)&&(De&&De.collectRelic(f.id||f.name),i++)})}}else _e.relics.forEach(a=>{const r=n.includes(a.name),f=e.some(c=>c.includes(a.name));(r||f)&&(De&&De.collectRelic(a.id||a.name),i++)});i===0&&_e.relics.length>0&&(De&&De.collectRelic(_e.relics[0].id||_e.relics[0].name),i=1),document.getElementById("relicsCount").textContent=`${i} / ${((s=_e.relics)==null?void 0:s.length)||0}`,ss=i>0||_e.relics.length===0}function ES(){if(!fn||!_e){fn||Pn("Editor is still loading, please wait...","warning");return}const t=fn.getValue();Mt(`Compiling (${Hn.toUpperCase()})...`,"info"),window._showGuideMsg&&window._showGuideMsg("runStart"),setTimeout(()=>{try{const e=lS(t,{language:Hn});if(e.logs.length>0&&e.logs.forEach(i=>{i.startsWith("ERROR:")?Mt(i.substring(6),"error"):i.startsWith("WARN:")?Mt(i.substring(5),"warning"):i.startsWith("INFO:")?Mt(i.substring(5),"info"):Mt(i,"info")}),e.errors.length>0&&!e.logs.some(i=>i.startsWith("ERROR:"))&&e.errors.forEach(i=>Mt(i,"error")),!e.success){Mt("❌ Execution failed due to error.","error"),Pn("Runtime error! Check console.","error"),window._showGuideMsg&&window._showGuideMsg("runError");return}Mt(`Execution completed in ${e.executionTime}ms`,"info");let n=cS(_e,e);Ni=n.passed;try{const i=Ys(Ui,_e.id);console.log("📤 Sending submission to backend:",{levelId:i,language:Hn,status:n.passed?"PASSED":"FAILED"}),fetch("/api/game/log-submission",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({levelId:i,language:Hn,code:t,status:n.passed?"PASSED":"FAILED"})}).then(s=>(console.log("✅ Backend response status:",s.status),s.json())).then(s=>console.log("✅ Backend response:",s)).catch(s=>console.error("❌ Submission logging error:",s))}catch(i){console.error("❌ Error preparing submission log:",i)}Pl(e,n.passed,n.commands);try{const i=Ys(Ui,_e.id);console.log("📤 Sending submission to backend:",{levelId:i,language:Hn,status:n.passed?"PASSED":"FAILED"}),fetch("/api/game/log-submission",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({levelId:i,language:Hn,code:t,status:n.passed?"PASSED":"FAILED"})}).then(s=>(console.log("✅ Backend response status:",s.status),s.json())).then(s=>console.log("✅ Backend response:",s)).catch(s=>console.error("❌ Submission logging error:",s))}catch(i){console.error("❌ Error preparing submission log:",i)}Pl(e,n.passed,n.commands),n.passed?window._showGuideMsg&&window._showGuideMsg("runSuccess"):(Qs++,Mt("============================","error"),Mt("❌ Test Failed!","error"),Mt(n.message,"warning"),Pn("Tests failed. Check console for hints.","error"),e.stack&&io(e.stack.getItems()),window._showGuideMsg&&window._showGuideMsg("runFailTests"))}catch(e){Qs++,Mt(`System Error: ${e.message}`,"error"),window._showGuideMsg&&window._showGuideMsg("runError")}},300)}function RS(){if(!Ni||!wi||!ss||kt!==100){Pn("Complete all level objectives first!","warning");return}vc()}function vc(){try{if(Vn)return;Vn=!0,window._showGuideMsg&&window._showGuideMsg("levelSuccess");const t=Fe.getLevelProgress(_e.worldId,_e.id).completed,e=no||{operations:De?De.lastProcessedOps:[],executionTime:0},n=fS(_e,e,Qi,Qs,t);Fe.completeLevel(_e.worldId,_e.id,n.stars),n.gold>0&&Fe.addGold(n.gold),n.mana>0&&Fe.addMana(n.mana),n.gems>0&&Fe.addGems(n.gems);const i=document.querySelector(".gold-val");i&&(i.textContent=Fe.player.gold.toLocaleString());const s=document.querySelector(".mana-val");s&&(s.textContent=Fe.player.mana.toLocaleString());const a=document.querySelector(".gems-val");a&&(a.textContent=Fe.player.gems.toLocaleString()),De&&De.openExit(),document.getElementById("sceneProgress").style.width="100%",document.getElementById("sceneProgressText").textContent="100%",Mt("============================","success"),Mt("🏆 LEVEL COMPLETE!","success"),setTimeout(()=>{console.log("handleSuccess: setTimeout fired, creating overlay...");const r=document.createElement("div");r.className="success-overlay",r.style.display="flex";const f=[];n.gold>0&&f.push({type:"Gold",amount:n.gold,icon:"🪙"}),n.mana>0&&f.push({type:"Mana",amount:n.mana,icon:"💎"}),n.gems>0&&f.push({type:"Gems",amount:n.gems,icon:"♦"});let c=f.map((l,u)=>`
      ...
      <div class="wood-modal">
        ...
        <div class="wood-board">
          ...
          <div class="wood-shelf">
            ...
            <div class="wood-shelf-ledge"></div>
            <div class="wood-shelf-text">YOU COMPLETED ${_e.title.toUpperCase()}!</div>
          </div>
    ...
    `,document.body.appendChild(r),console.log("handleSuccess: OVERLAY APPENDED TO DOM SUCCESSFULLY!"),document.getElementById("btnBackToMap").addEventListener("click",()=>{r.remove(),window.location.hash="#/"}),document.getElementById("btnWoodClose").addEventListener("click",()=>{r.remove()}),document.getElementById("btnNextLevel").addEventListener("click",()=>{r.remove(),window.location.hash=`#/problem/${_e.worldId}/${_e.id+1}`}),document.getElementById("btnReplayLevel").addEventListener("click",()=>{r.remove(),Vn=!1,so(),kr()})},1e3)}catch(t){Pn("handleSuccess error: "+t.message,"error")}}function PS(){De&&(De.stop(),De=null)}const Al=document.getElementById("app");let Ki=null;function Cl(){const t=window.location.hash||"#/";if(Ki==="worldMap"&&sS(),Ki==="problemView"&&PS(),t==="#/")Ki="worldMap",nS(Al);else if(t.startsWith("#/problem/")){const e=t.split("/");if(e.length===4){Ki="problemView";const n=e[2],i=e[3];gc(Al,n,i)}else window.location.hash="#/"}else t==="#/heroes"?(Ki="heroes",tS()):window.location.hash="#/"}async function AS(){window.addEventListener("hashchange",Cl),await Fe.syncWithBackend(),Cl(),window.addEventListener("storage",t=>{if(t.key==="codenest_theme"||t.key==="codenest-theme"){const e=t.newValue||"dark";document.documentElement.setAttribute("data-theme",e),document.documentElement.dataset.theme=e,e==="light"?document.documentElement.classList.add("light-mode"):document.documentElement.classList.remove("light-mode"),document.dispatchEvent(new CustomEvent("themeChanged",{detail:e}))}}),window.gameState=Fe,console.log("Code Nest initialized! 🪺")}AS();
